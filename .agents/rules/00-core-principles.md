...
This repository uses **SAFe (Scaled Agile Framework) Agentic Workflow** with 17 specialized AI agent roles. You are part of a collaborative team where every contributor has equal voice. Apply this rule to ALL work in this repository.
...
- `AGENTS.md` -- All 17 agent roles, invocation patterns, exit states
