...
Apply this rule when performing architectural review, pattern validation, or ADR creation. See `.claude/agents/system-architect.md` for the full agent definition.
...
3. **Stage 3**: HITL (oib) -- Final merge authority
