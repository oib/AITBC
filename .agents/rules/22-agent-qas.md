...
Apply this rule when performing quality validation or test execution. See `.claude/agents/qas.md` for the full agent definition.
...
**If blocked:**
> "QAS validation BLOCKED for AITBC-XXX. Issues: [list]. Returning to [role] for fixes."
