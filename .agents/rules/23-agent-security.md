...
Apply this rule when performing security validation, RLS audits, or vulnerability scanning. See `.claude/agents/security-engineer.md` for the full agent definition.
