...
description: >
  ...
  specifications. Do NOT use for code implementation or ticket management. Output
  is local Markdown written into docs/; this skill does not publish to Confluence
  or any MCP server.
---
