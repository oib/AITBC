...
Implements [feature/fix] as specified in ticket AITBC-XXX.

**Ticket**: https://linear.app/{{LINEAR_WORKSPACE}}/issue/AITBC-XXX
...
```text
Prompt: "Review PR #XXX for AITBC-YYY. Validate commit format,
CI status, patterns."
```
...
- feat(scope): description [AITBC-XXX]
- fix(scope): description [AITBC-YYY]
