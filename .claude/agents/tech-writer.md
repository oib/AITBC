...
checklist (`harness/claude/skills/stop-slop`; invoke the skill in interactive sessions, apply
...
Docs→Done exit-precondition checklist — live in `harness/claude/skills/docs-station/SKILL.md`.
