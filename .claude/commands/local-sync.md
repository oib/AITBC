...
```bash
# Example: AITBC-381-rename-slash-commands-remote-prefix
git branch -d AITBC-381-rename-slash-commands-remote-prefix
```
...
```bash
docker ps --filter name=AITBC --format 'table {{.Names}}\t{{.Status}}\t{{.State}}'
```
...
Latest:        fd85ba3 - feat(marketing): RenderTrust pages [AITBC-379]
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Docker Services (AITBC-401: STANDARD Ports)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

AITBC-dev-app:        ✅ Up 3 hours (healthy) → port 3000
AITBC-dev-postgres:   ✅ Up 3 hours (healthy) → port 5432
AITBC-dev-redis:      ✅ Up 3 hours (healthy) → port 6379
