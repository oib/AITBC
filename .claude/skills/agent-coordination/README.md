...
Guides correct agent assignment based on the 17-agent team structure, manages blocker escalation paths, and coordinates delivery across multiple specialists. Ensures TDM role boundaries are respected.
