...
Default to the laziest solution that actually works (`.devin/skills/ponytail`; invoke the skill in interactive sessions, apply its rules verbatim in headless seats):
