...
checklist (`.devin/skills/stop-slop`; invoke the skill in interactive sessions, apply
...
Docs→Done exit-precondition checklist — live in `.devin/skills/docs-station/SKILL.md`.
