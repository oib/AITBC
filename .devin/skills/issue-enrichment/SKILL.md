...
**Owner**: Issue Enrichment Agent (`.devin/agents/issue-enrichment.md`) — this
...
- **Owning agent**: `.devin/agents/issue-enrichment.md` (ABS-8)
- **Upstream gate**: `.devin/skills/duplicate-detection/SKILL.md` (runs FIRST, always)
