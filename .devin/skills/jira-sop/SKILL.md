...
Reuse the dev/staging/done templates from `.devin/skills/linear-sop/SKILL.md`; only
...
- **Dedup gate:** `.devin/skills/duplicate-detection/SKILL.md`
- **Ticket formatting:** `.devin/skills/issue-enrichment/SKILL.md`
- **Evidence templates:** `.devin/skills/linear-sop/SKILL.md`
