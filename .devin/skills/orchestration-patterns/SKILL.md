...
description: Agentic orchestration patterns for long-running tasks. Implements evidence-based
  delivery and Simon Willison's agent loop. Use when managing multi-step work, coordinating
  subagents, or orchestrating PR workflows.
triggers:
- user
- model
allowed-tools:
...
Prompt: "Review PR #XXX for AITBC-YYY. Validate:
...
All QAS reports go to: `docs/agent-outputs/qa-validations/AITBC-{number}-qa-validation.md`
