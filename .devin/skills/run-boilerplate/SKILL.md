...
```bash
.devin/skills/run-boilerplate/driver.sh smoke
```
...
```bash
eval "$(.devin/skills/run-boilerplate/driver.sh sandbox)"
...
.devin/skills/run-boilerplate/driver.sh clean    # remove sandboxes when done
```
