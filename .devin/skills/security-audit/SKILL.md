---
name: security-audit
description: RLS validation, security audits, OWASP compliance, and vulnerability
  scanning. Use when validating RLS policies, auditing API routes, or scanning for
  security issues.
triggers:
- user
- model
...
```markdown
## Security Audit Report - AITBC-XXX
