...
```bash
# Via Linear Web UI
# Navigate to: https://linear.app/team/{{PROJECT_TEAM_NAME}}/issue/AITBC-XXX

# Or use Linear CLI if installed
linear issue view AITBC-XXX
```
...
# Or use Linear CLI:
linear issue update AITBC-XXX --state "Done"
```
...
# Or use Linear CLI:
linear issue comment AITBC-XXX "**Dev Evidence**\n\n..."
```
