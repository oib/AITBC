...
```markdown
## QA Review - PR #XXX for AITBC-YYY

### Commit Message Validation
- [ ] Ticket reference in subject line
- [ ] Proper format: `type(scope): description [AITBC-XXX]`
...
All QA reports go to: `docs/agent-outputs/qa-validations/AITBC-{number}-qa-validation.md`
