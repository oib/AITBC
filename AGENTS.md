...
## Open Tasks Split (post v0.22 re-verification)

The following open findings from `docs/releases/v0.22/release.log` are split across the
two historical implementation agents. Assignments are based on codebase ownership and
required expertise.
