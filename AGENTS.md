...
**Current in-flight plan**: [v0.10.15](docs/releases/v0.10.15/change.log) — Monolithic Router/Module Decomposition (sync.py / bridge.py, trading_service/main.py, developer_platform router) — ✅ complete
