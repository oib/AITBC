...
class AgentDiscovery:
    ...
    def find_agents_by_capability(self, capability_type: CapabilityType, filters: dict = None) -> list[AgentInfo]:
    ...
    def find_agents_by_type(self, agent_type, filters: dict = None) -> list[AgentInfo]:
        """Find agents by type"""
