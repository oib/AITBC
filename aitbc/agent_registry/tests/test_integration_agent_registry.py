...
def test_list_agents_with_type_filter():
    ...
    registration1 = app.AgentRegistration(
        name="Trading Agent", type="trading", capabilities=["trading"], chain_id="ait-devnet", endpoint="http://localhost:8000"
    )
...
def test_list_agents_with_chain_filter():
    ...
    # Register agents
    registration1 = app.AgentRegistration(
        name="Devnet Agent", type="trading", capabilities=["trading"], chain_id="ait-devnet", endpoint="http://localhost:8000"
    )
    registration2 = app.AgentRegistration(
        name="Testnet Agent",
        type="trading",
