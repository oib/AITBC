"""
Permissions and Role-Based Access Control for AITBC services.

Extracted from ``apps/agent-coordinator/src/app/auth/permissions.py``.
Provides a comprehensive RBAC system with roles, permissions, and
