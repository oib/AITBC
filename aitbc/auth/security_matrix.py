...
ROUTE_SECURITY_MATRIX: dict[str, AuthLevel] = {
    ...
    "/v1/market/offers": AuthLevel.NONE,
    "/v1/market/stats": AuthLevel.NONE,
    "/v1/market/plugins": AuthLevel.NONE,
    "/v1/market/gpu/list": AuthLevel.NONE,
    "/v1/market/orders": AuthLevel.NONE,
    "/v1/market/pricing/*": AuthLevel.NONE,
    "/v1/market/miner-offers": AuthLevel.NONE,
    # Provider-bond lifecycle
    "/v1/market/providers/*/bonds": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/providers/*/eligibility": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/providers/*/bonds/lock": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/providers/*/bonds/release": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/providers/*/bonds/slash": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/bonds/*": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/offers": AuthLevel.NONE,
    # Admin routes
    "/v1/admin/*": AuthLevel.ADMIN,
    # Miner routes
    "/v1/miners/*": AuthLevel.MINER,
    "/v1/market/gpu/register": AuthLevel.MINER,
    "/v1/market/native-energy/profile": AuthLevel.MINER,
    ...
    "/v1/market/native-energy/profile/*": AuthLevel.NONE,
    "/v1/market/native-energy/floor": AuthLevel.NONE,
    "/v1/market/native-energy/rate": AuthLevel.MINER,
    "/v1/market/gpu/sell": AuthLevel.MINER,
    "/v1/market/gpu/*/release": AuthLevel.MINER,
    "/v1/market/gpu/*/confirm": AuthLevel.MINER,
    "/v1/market/gpu/*/delete": AuthLevel.MINER,
    "/v1/market/gpu/sync-offers": AuthLevel.MINER,
    ...
    "/v1/jobs/*": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/gpu/purchase": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/gpu/quote": AuthLevel.NONE,
    "/v1/market/gpu/*/book": AuthLevel.ADMIN_OR_CLIENT,
    "/v1/market/gpu/bid": AuthLevel.ADMIN_OR_CLIENT,
    ...
    "/v1/confidential/payments": AuthLevel.ADMIN_OR_CLIENT,
