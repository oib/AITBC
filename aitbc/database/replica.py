...
class ReadReplicaManager:
    ...
    def get_metrics(self) -> dict[str, Any]:
        ...
        return {'query_monitor': self.monitor.get_stats(), 'replica_count': len(self.replica_engines), 'read_weight': self.read_weight, 'slow_queries': [q.query for q in self.monitor.get_slow_queries(5)]}
