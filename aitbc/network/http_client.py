...
class AITBCHTTPClient:
    ...
    def __init__(self, base_url: str='', timeout: int=30, headers: dict[str, str] | None=None, max_retries: int=3, enable_cache: bool=False, cache_ttl: int=300, enable_logging: bool=False, circuit_breaker_threshold: int=5, rate_limit: int | None=None):
        """
    ...
    def post(self, endpoint: str, data: dict[str, Any] | None=None, json: dict[str, Any] | None=None, headers: dict[str, str] | None=None) -> dict[str, Any]:
        """
    ...
    def put(self, endpoint: str, data: dict[str, Any] | None=None, json: dict[str, Any] | None=None, headers: dict[str, str] | None=None) -> dict[str, Any]:
        """
        Perform PUT request.
    ...
    def delete(self, endpoint: str, params: dict[str, Any] | None=None, headers: dict[str, str] | None=None) -> dict[str, Any]:
        """
...
class AsyncAITBCHTTPClient:
    ...
    async def async_get(self, endpoint: str, params: dict[str, Any] | None=None, headers: dict[str, str] | None=None) -> dict[str, Any]:
        """
    ...
    async def async_post(self, endpoint: str, data: dict[str, Any] | None=None, json: dict[str, Any] | None=None, headers: dict[str, str] | None=None) -> dict[str, Any]:
        """
