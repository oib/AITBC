...
from aitbc.auth import Permission, get_current_user, permission_manager
...
async def get_system_status(
    ...
    try:
        ...
        status = {
            ...
            "system": {"memory_usage": memory.percent, "cpu_usage": cpu, "uptime": performance["uptime_seconds"]},
            "services": {
