...
Moved from hermes_service.handlers.strategies.manual_approval in v0.5.9 §3.
"""
...
class ManualApprovalStrategy(ApprovalStrategy):
    ...
    def approve(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        return {"approved": False, "reason": "Pending manual approval via CLI", "signed_transaction": None}
