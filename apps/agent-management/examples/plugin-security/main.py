...
async def list_security_reports(plugin_id: str | None = None,
...
async def list_vulnerabilities(severity: str | None = None,
...
async def get_security_dashboard():
    ...
    recent_scans = [r for r in scan_reports.values()
                   if datetime.fromisoformat(r["scan_date"]) > datetime.now(UTC) - timedelta(days=7)]
