...
class AgentSecurityManager:
    ...
    async def validate_workflow_security(self, workflow: AIAgentWorkflow, user_id: str) -> dict[str, Any]:
        ...
        await self.auditor.log_event(AuditEventType.WORKFLOW_CREATED, workflow_id=workflow.id, user_id=user_id, security_level=validation_result['required_security_level'], event_data={'validation_result': validation_result})
