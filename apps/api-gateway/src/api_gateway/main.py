...
def verify_auth(credentials: HTTPAuthorizationCredentials=Depends(security)) -> bool:
    ...
    return True
circuit_breaker_state: dict[str, dict[str, object]] = {name: {'failures': 0, 'last_failure_time': None, 'is_open': False} for name in SERVICES}
