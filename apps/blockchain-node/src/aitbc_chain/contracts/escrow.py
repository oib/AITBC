...
class EscrowManager:
            ...
            with session_scope() as session:
                ...
                for record in records:
                    ...
                    contract = EscrowContract(
                        ...
                        energy_quote_digest=record.energy_quote_digest,
                        energy_settlement_route=record.energy_settlement_route,
                        energy_settlement_asset=record.energy_settlement_asset,
                        energy_settlement_unit_scale=record.energy_settlement_unit_scale,
    ...
    async def _validate_milestones(
        ...
        for _i, milestone_data in enumerate(milestones):
    ...
    async def complete_milestone(
        self, contract_id: str, milestone_id: str, evidence: dict[Any, Any] | None = None
    ) -> tuple[bool, str]:
    ...
    async def get_active_contracts(self) -> list[EscrowContract]:
        ...
        return [
            self.escrow_contracts[contract_id] for contract_id in self.active_contracts if contract_id in self.escrow_contracts
        ]
    ...
    async def add_milestone(
        self, contract_id: str, milestone_id: str, amount: Decimal, description: str = ""
    ) -> tuple[bool, str]:
