...
class LeaseTracker:
    ...
    async def start(self) -> None:
        ...
        if self._running:
            ...
            return
        try:
            logger.info("Starting lease tracker with Redis URL: %s", _sanitize_url(self._redis_url or ""))
            ...
            logger.info("Redis client created: connected to %s", _sanitize_url(self._redis_url or ""))
