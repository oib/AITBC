...
async def get_genesis_allocations(
    ...
    from .blocks import get_genesis_allocations as _get_genesis_allocations
    return await _get_genesis_allocations(request, chain_id)
...
async def get_head(
    ...
    from .blocks import get_head as _get_head
    return await _get_head(request, chain_id)
...
async def get_block(
    ...
    """Get block by height"""
    from .blocks import get_block as _get_block
    return await _get_block(request, height, chain_id)
