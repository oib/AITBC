...
class PartnershipManager:
    ...
    async def create_partnership_program(self, session: Session, program_name: str, program_type: PartnershipType, description: str, created_by: str, **kwargs: Any) -> PartnershipProgram:
