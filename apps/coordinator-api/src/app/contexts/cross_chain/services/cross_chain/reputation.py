...
class CrossChainReputationService:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        self.stake_rewards = {
            ReputationTier.BRONZE: 0.05,
            ReputationTier.SILVER: 0.08,
            ReputationTier.GOLD: 0.12,
    ...
    async def stake_reputation(self, agent_id: str, amount: int, lock_period: int) -> ReputationStake:
        ...
        try:
            ...
            stake = ReputationStake(
                ...
                end_time=datetime.now(UTC) + timedelta(seconds=lock_period),
                is_active=True,
                reward_rate=reward_rate,
                multiplier=1.0 + reputation.score / 10000 * 0.5,
            )
