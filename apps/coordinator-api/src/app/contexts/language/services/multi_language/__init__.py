...
class MultiLanguageService:
    ...
    def _load_default_config(self) -> dict[str, Any]:
        ...
        return {'translation': {'openai': {'api_key': os.getenv('OPENAI_API_KEY'), 'model': 'gpt-4'}, 'google': {'api_key': os.getenv('GOOGLE_TRANSLATE_API_KEY')}, 'deepl': {'api_key': os.getenv('DEEPL_API_KEY')}}, 'cache': {'redis_url': os.getenv('REDIS_URL', 'redis://localhost:6379'), 'default_ttl': 86400, 'max_cache_size': 100000}, 'detection': {'fasttext': {'model_path': os.getenv('FASTTEXT_MODEL_PATH', 'lid.176.bin')}}, 'quality': {'thresholds': {'overall': 0.7, 'bleu': 0.3, 'semantic_similarity': 0.6, 'length_ratio': 0.5, 'confidence': 0.6}}}
...
__all__ = ['MultiLanguageService', 'multi_language_service', 'initialize_multi_language_service', 'get_translation_engine', 'get_language_detector', 'get_translation_cache', 'get_quality_checker']
