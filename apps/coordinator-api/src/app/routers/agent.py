"""
Agent Router - Agent communication API endpoints
...
if not settings.debug:
    # Create empty router for production — no agent mock endpoints
    ...
    _AGENT_NS = "agent:agents"
    _MSG_NS = "agent:messages"
    ...
    async def agent_health(request: Request) -> dict[str, Any]:
        ...
        return {"status": "healthy", "registered_agents": 0, "service": "agent"}
