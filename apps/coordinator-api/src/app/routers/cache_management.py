...
async def get_cache_statistics(request: Request, admin_key: Annotated[str, Depends(require_admin_key())]) -> dict[str, Any]:
...
@rate_limit(rate=20, per=60)
async def warm_up_cache(request: Request, admin_key: Annotated[str, Depends(require_admin_key())]) -> dict[str, Any]:
...
async def cache_health_check(request: Request, admin_key: Annotated[str, Depends(require_admin_key())]) -> dict[str, Any]:
