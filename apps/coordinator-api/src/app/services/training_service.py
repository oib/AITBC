...
class TrainingJob:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "resources": {"gpu_count": self.gpu_count, "memory_gb": self.memory_gb},
            "progress": {
            ...
            "metrics": {"loss": self.loss, "accuracy": self.accuracy, "validation_loss": self.validation_loss},
            "timestamps": {
...
class TrainingService:
    ...
    def create_training_job(
        ...
        job = TrainingJob(
            ...
            hyperparameters=hyperparameters or {"learning_rate": 0.001, "batch_size": 32, "optimizer": "adam"},
    ...
    def update_progress(
        self, job_id: str, epoch: int, step: int, loss: float, accuracy: float, validation_loss: float = 0.0
    ) -> TrainingJob:
