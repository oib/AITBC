...
from coordinator_api.contexts.edge_gpu.domain import ConsumerGPUProfile, EdgeGPUMetrics, GPUArchitecture
from coordinator_api.data.consumer_gpu_profiles import CONSUMER_GPU_PROFILES
