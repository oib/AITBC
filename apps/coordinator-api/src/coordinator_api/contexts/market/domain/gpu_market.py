"""Persistent SQLModel tables for the GPU market."""
...
class GPURegistry(SQLModel, table=True):
    """Registered GPUs available in the market."""
...
class UserProfile(SQLModel, table=True):
    ...
    price_range_min: Decimal = Field(default=Decimal("0.0"), max_digits=20, decimal_places=8)
    price_range_max: Decimal = Field(default=Decimal("1000.0"), max_digits=20, decimal_places=8)
...
class TrendData(SQLModel, table=True):
    ...
    avg_price: Decimal = Field(default=Decimal("0.0"), max_digits=20, decimal_places=8)
