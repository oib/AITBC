...
This is the AIT-native equivalent of ``aitbc.market.energy_oracle.EVMEnergyOracle``.
...
from aitbc.market.energy_oracle import EnergyOracleError
...
class NativeEnergyOracle:
    ...
    def get_energy_floor(
        ...
        from aitbc.market.energy_pricing import compute_energy_net_units
