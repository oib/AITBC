...
class TestPartnershipManager:
    ...
    @patch("coordinator_api.contexts.certification.services.certification.partnership_manager.Session")
    ...
    async def test_create_partnership_program(self, mock_session):
        ...
        from coordinator_api.contexts.certification.domain.certification import PartnershipProgram
        from coordinator_api.contexts.certification.services.certification.partnership_manager import PartnershipManager
    ...
    async def test_apply_for_partnership(self, mock_session):
        ...
        from coordinator_api.contexts.certification.domain.certification import AgentPartnership, PartnershipProgram
        from coordinator_api.contexts.certification.services.certification.partnership_manager import PartnershipManager
