...
class TestHermesIntegration:
    ...
    def test_conversation_thread(self, client: TestClient):
        ...
        # Register agents
        client.post(
            "/hermes/agents/register", json={"agent_id": "alice", "public_key": "alice-key", "capabilities": ["messaging"]}
        )
        client.post(
            "/hermes/agents/register", json={"agent_id": "bob", "public_key": "bob-key", "capabilities": ["messaging"]}
        )
