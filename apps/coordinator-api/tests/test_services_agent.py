...
class TestAgentService:
    ...
    @patch("app.contexts.agent_coordination.services.agent_service.AITBCHTTPClient")
    def test_get_agent_status(self, mock_client_class):
        ...
        # Import and test
        from app.contexts.agent_coordination.services.agent_service import get_agent_status
    ...
    def test_register_agent(self, mock_client_class):
        ...
        # Import and test
        from app.contexts.agent_coordination.services.agent_service import register_agent
