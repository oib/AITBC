...
class TestPaymentsService:
    ...
    def test_create_payment(self, mock_client_class):
        ...
        mock_client.post.return_value = {"id": "payment1", "amount": 100.0, "status": "pending"}
    ...
    def test_get_payment_status(self, mock_client_class):
        ...
        mock_client = Mock()
        mock_client_class.return_value = mock_client
        mock_client.get.return_value = {"id": "payment1", "status": "completed", "transaction_hash": "0xabc123"}
