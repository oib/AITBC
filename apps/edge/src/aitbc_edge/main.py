...
app = FastAPI(title='Edge API Service', description='REST API for AITBC island and edge operations', version='0.1.0', lifespan=lifespan, docs_url='/docs', redoc_url='/redoc')
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run('aitbc_edge.main:app', host=settings.api_host, port=settings.api_port, reload=True, log_level=settings.log_level.lower())