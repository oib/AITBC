...
async def health() -> HealthResponse:
    ...
    return HealthResponse(**create_simple_health_response("governance-service"))
...
if __name__ == "__main__":
    ...
    host = os.getenv("GOVERNANCE_BIND_HOST", "0.0.0.0")  # nosec B104 - intentional service bind-all; AITBC's systemd-only (Docker-free) services bind broadly by design, real boundary is the firewall/reverse-proxy layer
