        ...
        try:
            ...
            for gpu_info in discovered_gpus:
                ...
                if existing:
                    ...
                    existing.memory_gb = gpu_info['memory_mb'] // 1024  # Convert MB to GB
                    ...
                    new_gpu = GPURegistry(
                        ...
                        miner_id=miner_id,
                        model=gpu_info['name'],
                        memory_gb=gpu_info['memory_mb'] // 1024,  # Convert MB to GB
                        cuda_version=gpu_info['driver_version'],
                        status="available",
                        capabilities=["edge", "inference"]  # Default capabilities for discovered GPUs
                    )
            ...
            return {
                ...
                "edge_optimized": len(gpu_list),  # All discovered GPUs are considered edge-capable
