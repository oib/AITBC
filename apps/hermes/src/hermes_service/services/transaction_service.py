...
class TransactionService:
    ...
    def generate_signed_transaction(self, to_address: str, amount: int, fee: int=1000) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            transaction = {'from': self.genesis_address, 'to': to_address, 'amount': amount, 'nonce': actual_nonce, 'fee': fee, 'type': 'TRANSFER'}
