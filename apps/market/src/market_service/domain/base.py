...
`apps/coordinator-api` carries a market bounded context of its own, and the two overlap by
...
This service's own models therefore live here instead. `MarketOffer` deliberately does
