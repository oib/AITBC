...
class MarketRegion(MarketBase, table=True):
...
class GlobalMarketConfig(MarketBase, table=True):
...
class GlobalMarketOffer(MarketBase, table=True):
...
class GlobalMarketTransaction(MarketBase, table=True):
