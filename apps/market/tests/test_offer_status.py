...
`market_service.domain.offer_status` is the only thing standing between a status word
...
from market_service.domain.offer_status import spellings_of, to_offer_status, try_to_offer_status
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("booked", OfferStatus.RESERVED),  # MarketService.book_offer
