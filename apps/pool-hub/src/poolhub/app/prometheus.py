...
def reset_metrics() -> None:
    match_requests_total._value.set(0)
    match_candidates_returned._value.set(0)
    match_failures_total._value.set(0)
    match_latency_seconds._sum.set(0)
    match_latency_seconds._count.set(0)  # type: ignore[attr-defined]
    match_latency_seconds._samples = []  # type: ignore[assignment]
    miners_online_gauge._value.set(0)
