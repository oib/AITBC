...
@click.option("--hub", default="hub.example.net", help="Hub domain name to connect to")
...
@click.option("--hub-discovery-url", default="hub.example.net", help="DNS hub discovery URL")
@click.pass_context
