...
@island.command(
  ...
  aitbc node island join --island-id uuid --island-name hub --chain-id ait-mainnet --hub hub.example.net"""
)
...
@click.option("--hub", default="hub.aitbc.invalid", help="Hub domain name to connect to")
...
@click.option("--hub-discovery-url", default="hub.aitbc.invalid", help="DNS hub discovery URL")
@click.pass_context
