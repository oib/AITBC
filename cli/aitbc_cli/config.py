...
class CLIConfig(BaseAITBCConfig):
    ...
    gpu_service_url: str = Field(default="http://127.0.0.1:8101", description="GPU Service URL")
    ...
    trading_service_url: str = Field(default="http://127.0.0.1:8104", description="Trading Service URL")
    governance_service_url: str = Field(default="http://127.0.0.1:8105", description="Governance Service URL")
    ...
    edge_api_host: str = Field(default="127.0.0.1", description="Edge API host")
    edge_api_port: int = Field(default=8111, description="Edge API port")
    wallet_daemon_url: str = Field(default="http://127.0.0.1:8108", description="Wallet daemon URL")
    wallet_url: str = Field(default="http://127.0.0.1:8108", description="Wallet daemon URL (alias for compatibility)")
    blockchain_rpc_url: str = Field(default="http://127.0.0.1:8202", description="Blockchain RPC URL")
    explorer_api_url: str = Field(default="http://127.0.0.1:8100", description="Blockchain Explorer API URL")
