...
agent_task = _lazy("aitbc_cli.commands.agent_task", "agent_task", name="agent-task", group=True)
...
liquidity_stake = _lazy("aitbc_cli.commands.staking", "liquidity_stake", name="liquidity-stake")
...
service = _lazy("aitbc_cli.commands.service", "service", name="service", group=True)
...
stake = _lazy("aitbc_cli.commands.staking", "stake", name="stake")
...
tee = _lazy("aitbc_cli.commands.tee", "tee", name="tee", group=True)
...
unstake = _lazy("aitbc_cli.commands.staking", "unstake", name="unstake")
...
cli.add_command(agent_task, name="agent-task")
...
cli.add_command(stake)
cli.add_command(unstake)
cli.add_command(liquidity_stake, name="liquidity-stake")
