...
def register(subparsers: argparse._SubParsersAction, ctx: ParserContext) -> None:
        ...
        market_gpu_register_parser = market_gpu_subparsers.add_parser("register", help="Register GPU on marketplace (auto-detects from nvidia-smi)")
        market_gpu_register_parser.add_argument("--cuda-cores", type=int, help="Number of CUDA cores (optional, auto-detected if not provided)")
        market_gpu_register_parser.add_argument("--compute-capability", help="Compute capability (optional, auto-detected if not provided)")
        ...
        market_gpu_register_parser.add_argument("--miner-id", help="Miner ID (default: default_miner)")
        market_gpu_register_parser.add_argument("--wallet", help="Wallet address for blockchain registration")
        market_gpu_register_parser.add_argument("--signature", help="Transaction signature for blockchain registration")
