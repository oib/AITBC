...
```
 +------------------------------ Remote Server ----------------------------+
 |                                                                         |
 |  tmux session: factory-AITBC-123                            |
 |  +-------------------------------------------------------------------+ |
 |  |                    TDM (lead)                                     | |
 |  |                    Claude Code                                    | |
 |  +----------------+------------------+---------------+---------------+ |
...
tail -f ~/.dark-factory/logs/factory-AITBC-42/*.log

# Jump into a specific agent's pane to observe
./dark-factory/scripts/factory-attach.sh factory-AITBC-42 2

# End of day: Graceful shutdown
./dark-factory/scripts/factory-stop.sh factory-AITBC-42
```
...
```bash
./dark-factory/scripts/factory-attach.sh factory-AITBC-42 4
...
3. Attach read-only: `tmux attach -t factory-AITBC-42 -r`
