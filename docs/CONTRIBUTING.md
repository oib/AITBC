...
- For the current port and service reference, see [`reference/SERVICE_PORTS.md`](reference/SERVICE_PORTS.md).
- For CLI usage, see [`cli/README.md`](cli/README.md).
- For setup and node roles, see [`getting-started/README.md`](getting-started/README.md).
