# Agent Agent Blockchain Integration Overview

## Overview

This guide documents the blockchain integrations available to Agent agents for on-chain operations including staking, agent identity verification, governance decision recording, and GPU resource tracking. All integrations use the hub blockchain RPC at `hub.aitbc.bubuit.net:8202` for cross-node operations.
