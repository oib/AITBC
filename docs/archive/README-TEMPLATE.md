# AITBC SAFe-Agentic-Workflow Template
...
2. **Run the `apply-workflow.sh` script.**
   ...
   git clone https://github.com/oib/AITBC.git /tmp/{{LINEAR_WORKSPACE}}-workflow-template
...
2. **Report Issues**:
   - Found a bug? [Open an issue](https://github.com/oib/AITBC/issues)
   - Have a feature request? [Start a discussion](https://github.com/oib/AITBC/discussions)
