...
The AITBC RLS system uses PostgreSQL session variables to establish security context:
...
- **Modified**: AITBC-YYY ([description])
```
...
- [SECURITY_FIRST_ARCHITECTURE.md](../security/SECURITY_FIRST_ARCHITECTURE.md) - Security principles
