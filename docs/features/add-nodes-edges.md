...
- `Market` exposes `POST /v1/knowledge-graph/{graph_id}/nodes` (operation `add_node_v1_knowledge_graph__graph_id__nodes_post`) — Add Node
- `Market` exposes `POST /v1/knowledge-graph/{graph_id}/edges` (operation `add_edge_v1_knowledge_graph__graph_id__edges_post`) — Add Edge
...
- `POST /v1/knowledge-graph/{graph_id}/nodes` (`add_node_v1_knowledge_graph__graph_id__nodes_post`) on `Market`
- `POST /v1/knowledge-graph/{graph_id}/edges` (`add_edge_v1_knowledge_graph__graph_id__edges_post`) on `Market`
