...
- `Market` exposes `POST /v1/knowledge-graph` (operation `create_graph_v1_knowledge_graph_post`) — Create Graph
...
- `POST /v1/knowledge-graph` (`create_graph_v1_knowledge_graph_post`) on `Market`
