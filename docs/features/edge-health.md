...
- `Market` exposes `GET /v1/market/edge/{node_id}/health` (operation `get_edge_health_v1_market_edge__node_id__health_get`) — Get Edge Health
...
- `GET /v1/market/edge/{node_id}/health` (`get_edge_health_v1_market_edge__node_id__health_get`) on `Market`
