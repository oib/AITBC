...
- `Coordinator API` exposes `GET /v1/market/gpu/{gpu_id}` (operation `get_gpu_details_v1_market_gpu__gpu_id__get`) — Get Gpu Details
- `Openapi` exposes `GET /v1/market/gpu/{gpu_id}` (operation `get_gpu_details_v1_market_gpu__gpu_id__get`) — Get Gpu Details
...
- `GET /v1/market/gpu/{gpu_id}` (`get_gpu_details_v1_market_gpu__gpu_id__get`) on `Coordinator API`
- `GET /v1/market/gpu/{gpu_id}` (`get_gpu_details_v1_market_gpu__gpu_id__get`) on `Openapi`
