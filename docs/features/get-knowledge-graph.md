...
- `Market` exposes `GET /v1/knowledge-graph/{graph_id}` (operation `query_graph_v1_knowledge_graph__graph_id__get`) — Query Graph
...
- `GET /v1/knowledge-graph/{graph_id}` (`query_graph_v1_knowledge_graph__graph_id__get`) on `Market`
