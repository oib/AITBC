...
- API endpoint `GET /market/gpu/list` implemented in `apps/coordinator-api/src/coordinator_api/contexts/market/routers/market_gpu.py`
...
- `Coordinator API` exposes `GET /v1/market/gpu/list` (operation `list_gpus_v1_market_gpu_list_get`) — List Gpus
- `Openapi` exposes `GET /v1/market/gpu/list` (operation `list_gpus_v1_market_gpu_list_get`) — List Gpus
...
- `GET /v1/market/gpu/list` (`list_gpus_v1_market_gpu_list_get`) on `Coordinator API`
- `GET /v1/market/gpu/list` (`list_gpus_v1_market_gpu_list_get`) on `Openapi`
