...
- `apps/coordinator-api/src/coordinator_api/contexts/market/services/market_analytics.py` — Market Analytics Service for real-time metrics and trend analysis.
...
- API endpoint `GET /market/stats` implemented in `apps/coordinator-api/src/coordinator_api/contexts/market/routers/market.py`
- `Blockchain Node` exposes `GET /rpc/ai/stats` (operation `ai_stats_rpc_ai_stats_get`) — AI service statistics
- `Coordinator API` exposes `GET /v1/market/stats` (operation `get_market_stats_v1_market_stats_get`) — Get market summary statistics
...
- `GET /market/stats` (`get_market_stats` in `apps/coordinator-api/src/coordinator_api/contexts/market/routers/market.py`)
...
- `GET /v1/market/stats` (`get_market_stats_v1_market_stats_get`) on `Coordinator API`
