...
./aitbc-cli ai submit --wallet genesis --type multimodal --prompt "Multi-modal customer feedback analysis" --payment 1000
./aitbc-cli ai submit --wallet genesis --type fusion --prompt "Cross-modal fusion with joint reasoning" --payment 1200

# Phase 3: AI Resource Optimization
./aitbc-cli ai submit --wallet genesis --type resource-allocation --prompt "Dynamic resource allocation system" --payment 800
./aitbc-cli ai submit --wallet genesis --type performance-tuning --prompt "AI performance optimization" --payment 1000
```
