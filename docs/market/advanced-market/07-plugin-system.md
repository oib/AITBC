...
The PluginManager provides a production-ready plugin system for market extensions.
...
```python
from coordinator_api.contexts.market.services.plugin_manager import get_plugin_manager
