...
curl -s https://shop.example.net/api/v1/market/offer | jq '.offers[]'

# Get specific offer details (via API Gateway)
curl -s https://shop.example.net/api/v1/market/offer/ollama-nemotron-3-super-cloud | jq '.'
