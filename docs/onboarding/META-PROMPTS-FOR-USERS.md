...
**Purpose**: Copy-paste prompts to help you get started with the 17-agent team structure.
...
```
I want to set up the SAFe Multi-Agent Development methodology in my project. I've cloned the repository from https://github.com/oib/AITBC.

Please help me with the following:

1. **Agent Provider Selection**: I'm using [Claude Code / Augment Code / Other]. What do I need to do to install the 17 agent prompts?
...
5. **Template Customization**: I see placeholders like AITBC, AITBC, etc. Can you help me identify all placeholders I need to replace and where to find them?
...
Based on the SAFe multi-agent methodology with 17 agent roles:
...
**Setup Validation**:
- [ ] Repository cloned: `git clone https://github.com/oib/AITBC`
...
- **AGENTS.md**: Quick reference for all 17 agent roles
- **CONTRIBUTING.md**: Complete workflow guide
- **GitIngest Link**: https://gitingest.com/oib/AITBC

---

**Questions?** Open an issue on GitHub or contact andreas.fleckl@chello.at
