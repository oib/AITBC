...
grep -A 20 "Acceptance Criteria" specs/AITBC-XXX-{feature}-spec.md
...
```markdown
## QAS Validation Report - AITBC-XXX

**Session ID**: [Claude Code session ID]
**Date**: [YYYY-MM-DD]
**Spec**: specs/AITBC-XXX-{feature}-spec.md
...
mcp__linear-mcp__get_issue "AITBC-XXX"

# Read comments from implementers
mcp__linear-mcp__get_issue_comments "AITBC-XXX"

# Check ticket history for context
mcp__linear-mcp__get_issue_history "AITBC-XXX"
```
...
- **Action**: `ls specs/ | grep "AITBC-XXX"` or ask `@bsa`
