...
> **Note**: This document describes the current 25-command CLI structure. For authoritative port configuration, see [Service Ports Reference](./SERVICE_PORTS.md).

## Overview

The AITBC CLI provides a comprehensive command-line interface with 25 command groups for interacting with the AITBC network. It supports wallet management, blockchain operations, AI job submission, marketplace operations, agent orchestration, and system administration.
