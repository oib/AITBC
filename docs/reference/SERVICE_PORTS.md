...
- **Marketplace**: `apps/marketplace-service/src/marketplace_service/main.py` (line 558: `port=8102`)
...
- **Learning Service**: `systemd/aitbc-learning.service` (line 14: `--port 8012`)
- **Multimodal Service**: `systemd/aitbc-multimodal.service` (line 15: `--port 8020`)
- **Modality Optimization**: `systemd/aitbc-modality-optimization.service` (line 15: `--port 8021`)
