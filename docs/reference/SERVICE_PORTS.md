...
- **Agent Service**: `apps/agent-coordinator/src/agent_app/main.py` (line 33: `--port 8107`)
...
- **Plugin Service**: `apps/ai-engine/src/ai_service.py` (line 286: `port=8109`)
...
- **GPU Service**: `apps/gpu/src/gpu_service/main.py` (line 458: `port=8101`)
...
- **Agent Coordinator**: `apps/agent-coordinator/aitbc-agent-coordinator-wrapper.py` (line 38: `--port 8107`)
- **Plugin Service**: `apps/ai-engine/src/ai_service.py` (line 286: `port=8109`)
- **Whisper Service**: `apps/whisper/src/whisper/main.py` (line 42: `port=8110`)
