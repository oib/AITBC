...
v0.10.18  (update deployment stabilization) ✅ complete
  ...
  → v0.14.1  (TEE/FHE-Backed Verification & Confidential Compute Phase 1) ⏸ deferred to v2.0 (awaiting TEE/FHE hardware)
  → v0.14.2  (TEE/FHE-Backed Verification & Confidential Compute Phase 2) ⏸ deferred to v2.0 (awaiting TEE/FHE hardware)
...
- `v0.15.1` / `v0.15.2` — Data classification, consent, retention, audit log
  schema.
- `v0.14.1` / `v0.14.2` — TEE/FHE quote format, attestation API, sealing key flow. Deferred to release 2.0 until TEE/FHE hardware is available.
