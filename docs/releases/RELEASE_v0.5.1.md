...
AITBC v0.5.1 introduces a blockchain-native software marketplace for AI/ML services with on-chain proof of work. This release enables providers to offer software services (LLM inference, audio transcription, video transcoding) as discoverable marketplace offers, with metered escrow payments and immutable proof of job completion. The plugin registry provides agent-discoverable service metadata, and public nginx endpoints enable remote access to services.
...
- CLI v0.5.1+
- Blockchain node v0.5.1+
- Escrow service v0.5.1+
...
### v0.5.2 Planning
- Additional service types (image generation, TTS, translation)
- Service reputation and rating system
- Advanced pricing models (tiered, bulk discounts)
- Service health monitoring and auto-scaling

### v0.6.0 Planning
- GPU marketplace integration with software marketplace
- Unified marketplace for compute + software
