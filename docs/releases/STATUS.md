...
| v0.10.13 | Security & correctness hardening | 🚧 In Progress | credential hygiene, auth boundaries, signature verification, fake payments, file permissions, migration integrity, test coverage |
