...
- Line 228-229: user_distribution in_detect_wash_trading
...
- Line 325: price_history in_detect_price_anomalies
- Line 357: user_distribution in_detect_concentrated_trading
**Status**: ✅ Applied
...
- communication.py (line 74) - AgentCommunicationClient.**init**
- wallet_adapter.py (line 25) - WalletAdapter.**init**
