...
>
> **Prerequisites**: [v0.10.8](../v0.10/v0.10.8_change.log) (✅ complete — config consolidation & dead retry helper cleanup).
>
...
| # | Task | Priority | Files | Status |
|---|------|----------|-------|--------|
| B1 | Fix status drift — version bump, mark v0.10.4 complete, update STATUS.md | 🟡 P2 | `pyproject.toml`, `AGENTS.md`, `docs/releases/v0.10/v0.10.4_change.log`, `docs/releases/STATUS.md` | ✅ |
...
**Step 2**: Mark v0.10.4 as complete in `docs/releases/v0.10/v0.10.4_change.log`:
...
```markdown
- **v0.10.4** — Performance, Correctness & Cleanup: <ref_file file="/opt/aitbc/docs/releases/v0.10/v0.10.4_change.log" /> ✅ complete
```
