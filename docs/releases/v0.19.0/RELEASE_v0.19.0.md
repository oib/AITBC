...
The remaining Agent B tasks from `docs/releases/v0.18.0/AGENTS.md` are now implemented:
...
- `docs/releases/v0.19.0/AGENTS.md` — full agent split and release gate
- `docs/releases/v0.19.0/RELEASE_v0.19.0.md` — this file
