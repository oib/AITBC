...
- **Verification**: per-task regression tests live in `apps/blockchain-node/tests/`. See `docs/releases/v0.18/v0.18.0_AGENTS.md` for the original detailed acceptance criteria.
