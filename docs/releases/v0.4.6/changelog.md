...
- **[Advanced Agent Communication](ADVANCED_AGENT_COMMUNICATION.md)** - Message protocols, queues, capability discovery, workflows
- **[Service Reputation System](SERVICE_REPUTATION_SYSTEM.md)** - Rating system, weighted averages, reputation decay
- **[Reputation Blockchain Integration](REPUTATION_BLOCKCHAIN_INTEGRATION.md)** - On-chain reputation scores, audit trail, aggregation
- **[Agent Communication API](AGENT_COMMUNICATION_API.md)** - REST endpoints, WebSocket streams, workflow orchestration
- **[CLI Enhancements](CLI_ENHANCEMENTS.md)** - AI job management, agent communication, reputation commands
- **[Data Persistence](DATA_PERSISTENCE.md)** - Redis-based storage, SQLModel tables for reputation data
- **[Bug Fixes](BUG_FIXES.md)** - Test script fixes, blockchain RPC fixes, agent coordinator fixes
...
- [AGENT_COMMUNICATION.md](../../archive/agents/AGENT_COMMUNICATION.md) - Message protocols, encryption, discovery (archived)
- [AGENT_WORKFLOWS.md](../../archive/agents/AGENT_WORKFLOWS.md) - Workflow orchestration guide (archived)
