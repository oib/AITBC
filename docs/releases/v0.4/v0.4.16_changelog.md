...
- **[Cache Consolidation](v0.4.16_CACHE_CONSOLIDATION.md)** - Unified cache architecture, pluggable backends, deprecation warnings
- **[HTTP Client Consolidation](v0.4.16_HTTP_CLIENT_CONSOLIDATION.md)** - Unified HTTP client architecture, pluggable backends
- **[Monolithic Files Breakdown](v0.4.16_MONOLITHIC_FILES_BREAKDOWN.md)** - Split 7 monolithic files into 47 focused modules
- **[Security Fixes](v0.4.16_SECURITY_FIXES.md)** - Removed hardcoded secrets, encrypted wallet keys, replaced unsafe pickle, locked down CORS
- **[Operational Fixes](v0.4.16_OPERATIONAL_FIXES.md)** - Systemd fixes, backup script authentication, logging improvements, keystore permissions
- **[Migration Guide](v0.4.16_MIGRATION_GUIDE.md)** - Import migration instructions, deprecation timeline
