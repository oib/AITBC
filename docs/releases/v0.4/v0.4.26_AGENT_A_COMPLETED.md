...
- `apps/coordinator-api/src/app/contexts/agent_identity/domain/agent_identity.py` - Fixed duplicate **table_args** in 3 classes
...
- `aitbc/security_headers.py` - Added ASGI **call** method to SecurityHeadersMiddleware
