...
5. **Refactor queues/queue_manager.py into separate modules**
...
6. **Create shared ORM models package to resolve SQLAlchemy table conflicts**
...
7. **Migrate CLI integration tests from StarletteTestClient to httpx.AsyncClient**
...
8. **Replace datetime.utcnow() with timezone-aware timestamps**
...
9. **Migrate Pydantic v1 Config class to ConfigDict (model_config)**
...
## Additional Commits (Phase 6-7)
 ...
 6. **Create route security matrix documentation for auth normalization**
