...
- **[Port Architecture Reorganization](v0.4.4_PORT_ARCHITECTURE.md)** - Port standardization, public vs internal services, migration guide
- **[Microservices Consolidation](v0.4.4_MICROSERVICES_CONSOLIDATION.md)** - GPU service removal, blockchain-based registration
- **[Wallet Daemon Enhancements](v0.4.4_WALLET_DAEMON.md)** - Balance endpoint, genesis wallet auto-import, metadata merging
- **[Hermes Messaging Updates](v0.4.4_HERMES_MESSAGING.md)** - Port changes, endpoint updates, database path fixes
- **[Agent Coordinator Integration](v0.4.4_AGENT_COORDINATOR.md)** - Hermes integration, CLI updates
- **[Environment Configuration](v0.4.4_ENVIRONMENT_CONFIG.md)** - blockchain.env and node.env, loading order
- **[Blockchain RPC Updates](v0.4.4_BLOCKCHAIN_RPC.md)** - New endpoints, GPU_REGISTER transactions, network discovery
...
2. **Create Environment Files**
   ...
   HUB_BLOCKCHAIN_URL=http://hub.example.net:8202
   EOF
...
- [WALLET_DAEMON.md](v0.4.4_WALLET_DAEMON.md) — Balance endpoint documentation
- [BLOCKCHAIN_RPC.md](v0.4.4_BLOCKCHAIN_RPC.md) — Updated RPC endpoints
