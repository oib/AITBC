...
- **[Advanced Agent Communication](v0.4.6_ADVANCED_AGENT_COMMUNICATION.md)** - Message protocols, queues, capability discovery, workflows
- **[Service Reputation System](v0.4.6_SERVICE_REPUTATION_SYSTEM.md)** - Rating system, weighted averages, reputation decay
- **[Reputation Blockchain Integration](v0.4.6_REPUTATION_BLOCKCHAIN_INTEGRATION.md)** - On-chain reputation scores, audit trail, aggregation
- **[Agent Communication API](v0.4.6_AGENT_COMMUNICATION_API.md)** - REST endpoints, WebSocket streams, workflow orchestration
- **[CLI Enhancements](v0.4.6_CLI_ENHANCEMENTS.md)** - AI job management, agent communication, reputation commands
- **[Data Persistence](v0.4.6_DATA_PERSISTENCE.md)** - Redis-based storage, SQLModel tables for reputation data
- **[Bug Fixes](v0.4.6_BUG_FIXES.md)** - Test script fixes, blockchain RPC fixes, agent coordinator fixes
