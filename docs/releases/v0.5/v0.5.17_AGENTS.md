...
- **[Overview](./v0.5.17_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.5.17_agent-a.md)** - Type safety & shared core implementation (logging alias, chain_id signing, unit tests)
- **[Agent B Tasks](./v0.5.17_agent-b.md)** - Bug fixes, infrastructure & apps (fixture registration, collection errors, dead files, verifier side)
...
- [Status Baseline](./v0.5.17_overview.md#status-baseline--already-done-verified-do-not-redo)
- [Task Split Overview](./v0.5.17_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.5.17_agent-a.md#scope)
- [Tasks](./v0.5.17_agent-a.md#tasks)
- [BlockchainTextFormatter backward-compat alias](./v0.5.17_agent-a.md#a1-blockchaintextformatter-backward-compat-alias)
- [Add chain_id to signed message](./v0.5.17_agent-a.md#a2-add-chain_id-to-signed-message-signer-side)
- [Update transaction service unit tests](./v0.5.17_agent-a.md#a3-update-transaction-service-unit-tests)
- [Fix test_core.py collection error](./v0.5.17_agent-a.md#a4-fix-test_corepy-collection-error)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.5.17_agent-b.md#scope)
- [Tasks](./v0.5.17_agent-b.md#tasks)
- [Register multi-chain and multi-node fixtures](./v0.5.17_agent-b.md#b1-register-multi-chain-and-multi-node-fixtures)
- [Fix CLI integration test collection error](./v0.5.17_agent-b.md#b2-fix-cli-integration-test-collection-error)
- [Delete dead handler test files](./v0.5.17_agent-b.md#b3-delete-dead-handler-test-files)
- [Add chain_id to tx_data_dict](./v0.5.17_agent-b.md#b4-add-chain_id-to-tx_data_dict-in-submit_transaction)
- [Update signing round-trip test](./v0.5.17_agent-b.md#b5-update-test_signing_round_trippy)
- [Triage remaining skipped CLI tests](./v0.5.17_agent-b.md#b6-triage-remaining-127-skipped-cli-tests)
- [Update change.log](./v0.5.17_agent-b.md#b7-update-changelog)
...
| B7 | Update `change.log` with accurate test results after all fixes. | Low | `docs/releases/v0.5/v0.5.17_change.log` | ✅ DONE |
...
- Update `docs/releases/v0.5/v0.5.17_change.log` lines 288-304 (Final Test Results table) with actual numbers.
...
| `docs/releases/v0.5/v0.5.17_change.log` | Agent B | B7: update test results |
