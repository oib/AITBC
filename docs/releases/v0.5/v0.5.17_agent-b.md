...
- Update the test results table in `docs/releases/v0.5/v0.5.17_change.log` to reflect the actual state after all fixes:
...
- [Overview](./v0.5.17_overview.md) - Release overview and status baseline
