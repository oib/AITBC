...
- [Agent A Tasks](./v0.5.17_agent-a.md) - Shared core implementation details
- [Agent B Tasks](./v0.5.17_agent-b.md) - Bug fixes, infrastructure & apps implementation details
