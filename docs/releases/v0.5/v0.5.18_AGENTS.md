...
>
> **Scope note**: Full investigation + per-file root causes are in <ref_file file="/opt/aitbc/docs/releases/v0.5/v0.5.18_suggestions.md" />. All 72 failures verified pre-existing at commit `3d94338c2`.
...
- **[Overview](./v0.5.18_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.5.18_agent-a.md)** - Shared test config & infrastructure (pytest markers, auto-skip fixtures, testpaths)
- **[Agent B Tasks](./v0.5.18_agent-b.md)** - Blockchain-node test fixes (16 test files, stale assertions, infra quarantine)
...
- [Status Baseline](./v0.5.18_overview.md#status-baseline--verified-facts-do-not-re-investigate)
- [Task Split Overview](./v0.5.18_overview.md#task-split-overview)

### Agent A (Shared Test Config)

- [Scope](./v0.5.18_agent-a.md#scope)
- [Tasks](./v0.5.18_agent-a.md#tasks)
- [Register markers + default timeout](./v0.5.18_agent-a.md#a1-register-markers--default-timeout)
- [Auto-skip fixtures](./v0.5.18_agent-a.md#a2-auto-skip-fixtures)
- [Add to testpaths (LAST)](./v0.5.18_agent-a.md#a3-add-to-testpaths-last)

### Agent B (Blockchain-Node Test Fixes)

- [Scope](./v0.5.18_agent-b.md#scope)
- [Tasks](./v0.5.18_agent-b.md#tasks)
- [test_rpc_router](./v0.5.18_agent-b.md#b1-test_rpc_router-12)
- [test_guardian_contract](./v0.5.18_agent-b.md#b2-test_guardian_contract-14)
- [test_mempool](./v0.5.18_agent-b.md#b3-test_mempool-8)
- [Monkeypatch-target drift](./v0.5.18_agent-b.md#b4-monkeypatch-target-drift-9)
- [Quarantine infra tests](./v0.5.18_agent-b.md#b5-quarantine-infra-tests-12)
- [Remaining stale assertions](./v0.5.18_agent-b.md#b6-remaining-stale-assertions-17)
- [Green run + fix v0.5.17 docs](./v0.5.18_agent-b.md#b7-green-run--fix-v0517-docs)
...
| B7 | Full-suite green run + correct v0.5.17 Final Test Results table. | Medium | `docs/releases/v0.5/v0.5.17_change.log` | ✅ DONE |
...
- Run the full suite; confirm 0 failed / 0 errors (infra skipped). Then correct the Final Test Results table in `docs/releases/v0.5/v0.5.17_change.log` (it measured only 3 of 17 blockchain-node files).
...
| `docs/releases/v0.5/v0.5.17_change.log` | Agent B | B7 |
