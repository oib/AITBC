...
- [Agent A Tasks](./v0.5.18_agent-a.md) - Shared test config & infrastructure implementation details
- [Agent B Tasks](./v0.5.18_agent-b.md) - Blockchain-node test fixes implementation details
