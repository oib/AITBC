...
>
> **Prerequisites**: [v0.5.18](../v0.5/v0.5.18_change.log) ✅.
>
...
- **[Overview](./v0.5.19_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.5.19_agent-a.md)** - Shared core implementation (ReputationDTO)
- **[Agent B Tasks](./v0.5.19_agent-b.md)** - Apps & infrastructure implementation (certification refactor, pricing cleanup, fakeredis)
...
- [Status Baseline](./v0.5.19_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.5.19_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.5.19_agent-a.md#scope)
- [Tasks](./v0.5.19_agent-a.md#tasks)
- [ReputationDTO](./v0.5.19_agent-a.md#a1-reputationdto)
- [Unit tests](./v0.5.19_agent-a.md#a2-unit-tests-for-reputationdto)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.5.19_agent-b.md#scope)
- [Tasks](./v0.5.19_agent-b.md#tasks)
- [Certification Refactor](./v0.5.19_agent-b.md#b1-certification-refactor)
- [Resolve Duplicate Pricing Models](./v0.5.19_agent-b.md#b2-resolve-duplicate-pricing-models)
- [Wire or Remove Unused Pricing Tables](./v0.5.19_agent-b.md#b3-wire-or-remove-unused-pricing-tables)
- [fakeredis](./v0.5.19_agent-b.md#b4-add-fakeredis-dependency--fix-misleading-conftest_sqlitepy-comment)
- [Integration Tests](./v0.5.19_agent-b.md#b5-integration-tests)
