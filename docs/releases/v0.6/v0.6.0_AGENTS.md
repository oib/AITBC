...
>
> **Prerequisites**: [v0.5.18](../v0.5/v0.5.18_change.log) (green blockchain-node test suite — the regression baseline).
...
- **[Overview](./v0.6.0_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.6.0_agent-a.md)** - Shared core implementation (cache fixes, HTTP pool, compression, benchmarking)
- **[Agent B Tasks](./v0.6.0_agent-b.md)** - Apps & infrastructure implementation (indexes, connection pooling, N+1 elimination, batch operations)
...
- [Status Baseline](./v0.6.0_overview.md#status-baseline--verified-code-targets-from-subagent-investigation)
- [Task Split Overview](./v0.6.0_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.0_agent-a.md#scope)
- [Tasks](./v0.6.0_agent-a.md#tasks)
- [Fix BlockchainCache typing](./v0.6.0_agent-a.md#a1-fix-blockchaincache-typing--add-block-by-hash)
- [In-process BlockHeaderCache](./v0.6.0_agent-a.md#a2-in-process-blockheadercache)
- [Shared async HTTP connection pool](./v0.6.0_agent-a.md#a3-shared-async-http-connection-pool)
- [Compression utility](./v0.6.0_agent-a.md#a4-compression-utility)
- [Benchmarking helpers](./v0.6.0_agent-a.md#a5-benchmarking-helpers)
- [Unit tests](./v0.6.0_agent-a.md#a6-unit-tests)
- [Verify clean](./v0.6.0_agent-a.md#a7-verify-clean)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.0_agent-b.md#scope)
- [Tasks](./v0.6.0_agent-b.md#tasks)
- [Add missing indexes](./v0.6.0_agent-b.md#b1-add-missing-indexes--alembic-migration)
- [Wire up connection pooling](./v0.6.0_agent-b.md#b2-wire-up-connection-pooling)
- [Eliminate N+1 queries](./v0.6.0_agent-b.md#b3-eliminate-n1-queries)
- [Batch mempool operations](./v0.6.0_agent-b.md#b4-batch-mempool-operations)
- [Incremental state root](./v0.6.0_agent-b.md#b5-incremental-state-root)
- [Wire up shared HTTP client pool](./v0.6.0_agent-b.md#b6-wire-up-shared-http-client-pool)
- [Wire up compression + block header caching](./v0.6.0_agent-b.md#b7-wire-up-compression--block-header-caching)
- [Performance benchmarks](./v0.6.0_agent-b.md#b8-performance-benchmarks--verify-targets)
