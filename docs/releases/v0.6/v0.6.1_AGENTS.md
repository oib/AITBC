...
>
> **Prerequisites**: [v0.6.0](../v0.6/v0.6.0_change.log) (DB & Network Optimization — batch-fetching, incremental state root, connection pooling). The v0.6.0 batch-fetching in `poa.py:276-305` (all accounts pre-fetched into `account_map`) is the foundation for parallel execution.
>
...
- **[Overview](./v0.6.1_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.1_agent-a.md)** - Shared core implementation (DependencyGraph, ParallelExecutor, unit tests)
- **[Agent B Tasks](./v0.6.1_agent-b.md)** - Apps & infrastructure implementation (pure state transitions, parallel validation wiring, determinism tests)
...
- [Status Baseline](./v0.6.1_overview.md#status-baseline--verified-code-targets-from-subagent-investigation)
- [Architecture: Parallel Tx Validation Approach](./v0.6.1_overview.md#architecture-parallel-tx-validation-approach)
- [Task Split Overview](./v0.6.1_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.1_agent-a.md#scope)
- [Tasks](./v0.6.1_agent-a.md#tasks)
- [DependencyGraph](./v0.6.1_agent-a.md#a1-dependencygraph)
- [ParallelExecutor](./v0.6.1_agent-a.md#a2-parallelexecutor)
- [Unit tests](./v0.6.1_agent-a.md#a3-unit-tests)
- [Verify clean](./v0.6.1_agent-a.md#a4-verify-clean)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.1_agent-b.md#scope)
- [Tasks](./v0.6.1_agent-b.md#tasks)
- [Pure state transition](./v0.6.1_agent-b.md#b1-pure-state-transition)
- [Wire up parallel tx validation in poa.py](./v0.6.1_agent-b.md#b2-wire-up-parallel-tx-validation-in-poapy)
- [Wire up parallel tx validation in sync.py](./v0.6.1_agent-b.md#b3-wire-up-parallel-tx-validation-in-syncpy)
- [Fix mempool ordering determinism](./v0.6.1_agent-b.md#b4-fix-mempool-ordering-determinism)
- [Add parallel processing config](./v0.6.1_agent-b.md#b5-add-parallel-processing-config)
- [Apply incremental state root to sync path](./v0.6.1_agent-b.md#b6-apply-incremental-state-root-to-sync-path)
- [Determinism tests](./v0.6.1_agent-b.md#b7-determinism-tests)
- [Performance benchmarks](./v0.6.1_agent-b.md#b8-performance-benchmarks)
