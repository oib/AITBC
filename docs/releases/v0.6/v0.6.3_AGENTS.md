...
>
> **Prerequisites**: [v0.6.0](../v0.6/v0.6.0_change.log) (network compression), [v0.6.2](../v0.6/v0.6.2_change.log) (sync & gossip optimization), [v0.5.16](../v0.5/v0.5.16_change.log) (multi-chain preparation — chain_id bug fixes). All complete.
>
...
- **[Overview](./v0.6.3_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.3_agent-a.md)** - Shared core implementation (SyncSourceResolver, IslandRegistry, SubscriptionManager, unit tests)
- **[Agent B Tasks](./v0.6.3_agent-b.md)** - Apps & infrastructure implementation (config, multi-hub subscription, island manager, CLI, tests)
...
- [Status Baseline](./v0.6.3_overview.md#status-baseline--verified-code-targets)
- [Already Implemented](./v0.6.3_overview.md#already-implemented-verified--no-work-needed)
- [Gossip Topic Migration Window](./v0.6.3_overview.md#gossip-topic-migration-window-v062--v063)
- [Architecture](./v0.6.3_overview.md#architecture-multi-hub-subscription)
- [Pre-Coding Integration Test](./v0.6.3_overview.md#pre-coding-integration-test)
- [Task Split Overview](./v0.6.3_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.3_agent-a.md#scope)
- [Tasks](./v0.6.3_agent-a.md#tasks)
- [SyncSourceResolver](./v0.6.3_agent-a.md#a1-syncsourceresolver)
- [IslandRegistry](./v0.6.3_agent-a.md#a2-islandregistry)
- [Unit Tests](./v0.6.3_agent-a.md#a3-unit-tests)
- [SubscriptionManager](./v0.6.3_agent-a.md#a4-subscriptionmanager)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.3_agent-b.md#scope)
- [Tasks](./v0.6.3_agent-b.md#tasks)
- [Config Fields](./v0.6.3_agent-b.md#b1-add-config-fields)
- [SyncSourceResolver Wiring](./v0.6.3_agent-b.md#b2-wire-up-syncsourceresolver-in-mainpy)
- [Multi-Hub Subscription](./v0.6.3_agent-b.md#b3-multi-hub-subscription-in-mainpy)
- [Island Manager Activation](./v0.6.3_agent-b.md#b4-enable-island-manager-background-tasks)
- [CLI Commands](./v0.6.3_agent-b.md#b5-add-chain-sync-status-cli-command)
- [Island CLI Commands](./v0.6.3_agent-b.md#b6-add-node-island-health--fix-node-island-list)
- [Integration Tests](./v0.6.3_agent-b.md#b7-integration-tests)
- [Verification](./v0.6.3_agent-b.md#b8-verify-full-test-suite)
- [Coordination Protocol](./v0.6.3_agent-b.md#coordination-protocol)
- [Dependency Graph](./v0.6.3_agent-b.md#dependency-graph)
- [Success Criteria](./v0.6.3_agent-b.md#success-criteria)
