...
>
> **Prerequisites**: [v0.6.1](../v0.6/v0.6.1_change.log) (Parallel Processing — multiple proposers as parallel tasks), [v0.6.3](../v0.6/v0.6.3_change.log) (Multi-Island Node Support — island-to-chain registry infrastructure). All complete.
>
...
- **[Overview](./v0.6.4_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.4_agent-a.md)** - Shared core implementation (PortAllocator, ChainConfigParser, unit tests)
- **[Agent B Tasks](./v0.6.4_agent-b.md)** - Apps & infrastructure implementation (config, IslandMembership, MultiChainManager, CLI, tests)
...
- [Status Baseline](./v0.6.4_overview.md#status-baseline--verified-code-targets)
- [Already Implemented](./v0.6.4_overview.md#already-implemented-verified--no-work-needed)
- [Architecture](./v0.6.4_overview.md#architecture-multi-chain-per-island)
- [join_island() Caller Inventory](./v0.6.4_overview.md#join_island-caller-inventory-8-call-sites--atomic-refactor-required)
- [Task Split Overview](./v0.6.4_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.4_agent-a.md#scope)
- [Tasks](./v0.6.4_agent-a.md#tasks)
- [PortAllocator](./v0.6.4_agent-a.md#a1-portallocator)
- [ChainConfigParser](./v0.6.4_agent-a.md#a2-chainconfigparser)
- [Unit Tests](./v0.6.4_agent-a.md#a3-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.4_agent-b.md#scope)
- [Tasks](./v0.6.4_agent-b.md#tasks)
- [Config Fields](./v0.6.4_agent-b.md#b1-add-config-fields)
- [IslandMembership Refactor](./v0.6.4_agent-b.md#b2-refactor-islandmembership)
- [Atomic join_island Refactor](./v0.6.4_agent-b.md#b3-atomic-join_island-refactor)
- [MultiChainManager Wiring](./v0.6.4_agent-b.md#b4-wire-multichainmanager-into-mainpy)
- [Threshold Guards](./v0.6.4_agent-b.md#b5-threshold-guards)
- [CLI Commands](./v0.6.4_agent-b.md#b6-cli-commands)
- [make_genesis.py Multi-Genesis](./v0.6.4_agent-b.md#b7-make_genesispy-multi-genesis)
- [Integration Tests](./v0.6.4_agent-b.md#b8-integration-tests)
- [Verification](./v0.6.4_agent-b.md#b9-verify-full-test-suite)
- [Dependency Graph](./v0.6.4_agent-b.md#dependency-graph)
- [Coordination](./v0.6.4_agent-b.md#coordination)
- [Success Criteria](./v0.6.4_agent-b.md#success-criteria)
