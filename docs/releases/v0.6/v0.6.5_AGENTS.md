...
>
> **Prerequisites**: [v0.5.16](../v0.5/v0.5.16_change.log) (chain_id-aware transaction submission — Bug 15/16 fixed), [v0.6.3](../v0.6/v0.6.3_change.log) (Multi-Island Node Support), [v0.6.4](../v0.6/v0.6.4_change.log) (Multi-Chain Per Island). v0.5.16 fixes verified in codebase. v0.6.4 in progress.
>
...
- **[Overview](./v0.6.5_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.5_agent-a.md)** - Shared core implementation (PaymentEscrow utility, unit tests)
- **[Agent B Tasks](./v0.6.5_agent-b.md)** - Apps & infrastructure implementation (agent-coordinator service integration)
...
- [Status Baseline](./v0.6.5_overview.md#status-baseline--verified-code-targets-from-subagent-investigation)
- [Already Fixed](./v0.6.5_overview.md#already-fixed-verified--no-work-needed)
- [Architecture: Agent Coordination with Chain Awareness](./v0.6.5_overview.md#architecture-agent-coordination-with-chain-awareness)
- [Task Split Overview](./v0.6.5_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.5_agent-a.md#scope)
- [Tasks](./v0.6.5_agent-a.md#tasks)
- [PaymentEscrow](./v0.6.5_agent-a.md#a1-paymentescrow)
- [Unit tests](./v0.6.5_agent-a.md#a2-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.5_agent-b.md#scope)
- [Tasks](./v0.6.5_agent-b.md#tasks)
- [Add config fields](./v0.6.5_agent-b.md#b1-add-config-fields)
- [Add chain_id/island_id to agent models](./v0.6.5_agent-b.md#b2-add-chain_idisland_id-to-agent-models)
- [Add chain_id/payment to task models](./v0.6.5_agent-b.md#b3-add-chain_idpayment-to-task-models--escrow-integration)
- [Add chain_id to swarm + workflow models](./v0.6.5_agent-b.md#b4-add-chain_id-to-swarm--workflow-models)
- [Make agent TTL configurable](./v0.6.5_agent-b.md#b5-make-agent-ttl-configurable)
- [Integration tests](./v0.6.5_agent-b.md#b6-integration-tests)
- [Verify full test suite](./v0.6.5_agent-b.md#b7-verify-full-test-suite--mypy--ruff-clean)
