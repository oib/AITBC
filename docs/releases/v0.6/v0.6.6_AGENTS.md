...
>
> **Prerequisites**: [v0.6.5](../v0.6/v0.6.5_change.log) (Agent Coordination — task assignment, PaymentEscrow), [v0.6.3](../v0.6/v0.6.3_change.log) (Multi-Island), [v0.6.4](../v0.6/v0.6.4_change.log) (Multi-Chain Per Island), [v0.5.16](../v0.5/v0.5.16_change.log) (chain_id-aware transactions). All verified complete.
>
...
- **[Overview](./v0.6.6_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.6_agent-a.md)** - Shared core implementation (OfferFSM, BlockchainRPCClient, unit tests)
- **[Agent B Tasks](./v0.6.6_agent-b.md)** - Apps & infrastructure implementation (marketplace, GPU, edge services integration)
...
- [Status Baseline](./v0.6.6_overview.md#status-baseline--verified-code-targets-from-subagent-investigation)
- [Already Fixed](./v0.6.6_overview.md#already-fixed-verified--no-work-needed)
- [Architecture: Compute Marketplace with Chain Awareness](./v0.6.6_overview.md#architecture-compute-marketplace-with-chain-awareness)
- [Task Split Overview](./v0.6.6_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.6_agent-a.md#scope)
- [Tasks](./v0.6.6_agent-a.md#tasks)
- [OfferFSM](./v0.6.6_agent-a.md#a1-offerfsm)
- [BlockchainRPCClient](./v0.6.6_agent-a.md#a2-blockchainrpcclient)
- [Unit tests](./v0.6.6_agent-a.md#a3-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.6_agent-b.md#scope)
- [Tasks](./v0.6.6_agent-b.md#tasks)
- [Marketplace config](./v0.6.6_agent-b.md#b1-marketplace-config)
- [GPU service config](./v0.6.6_agent-b.md#b2-gpu-service-config)
- [Marketplace integration](./v0.6.6_agent-b.md#b3-marketplace-use-blockchainrpcclient-a1)
- [GPU service integration](./v0.6.6_agent-b.md#b4-gpu-service-use-blockchainrpcclient-a1)
- [Edge service fixes](./v0.6.6_agent-b.md#b5-edge-service-fix-schema-mismatches)
- [Marketplace matching](./v0.6.6_agent-b.md#b6-marketplace-matching)
- [Integration tests](./v0.6.6_agent-b.md#b7-integration-tests)
- [Verify full test suite](./v0.6.6_agent-b.md#b8-verify-full-test-suite--ruff--mypy-clean)
