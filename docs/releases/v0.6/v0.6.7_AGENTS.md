...
>
> **Prerequisites**: [v0.6.5](../v0.6/v0.6.5_change.log) (Agent Coordination — miners register as agents), [v0.6.6](../v0.6/v0.6.6_change.log) (Compute Marketplace — jobs come from marketplace matches), [v0.5.16](../v0.5/v0.5.16_change.log) (chain_id-aware transactions). v0.6.6 Agent A complete (OfferFSM + BlockchainRPCClient available in `aitbc.marketplace`).
>
...
- **[Overview](./v0.6.7_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.6.7_agent-a.md)** - Shared core implementation (RewardPolicy, TransactionService fix, unit tests)
- **[Agent B Tasks](./v0.6.7_agent-b.md)** - Apps & infrastructure implementation (pool-hub settings, blockchain client, reward distribution, miner registration, tests)
...
- [Status Baseline](./v0.6.7_overview.md#status-baseline--verified-code-targets)
- [Already Fixed / Exists](./v0.6.7_overview.md#already-fixed--exists-verified--no-work-needed)
- [Architecture](./v0.6.7_overview.md#architecture-pool-hub-with-blockchain-rewards)
- [Task Split Overview](./v0.6.7_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.6.7_agent-a.md#scope)
- [Tasks](./v0.6.7_agent-a.md#tasks)
- [RewardPolicy](./v0.6.7_agent-a.md#a1-rewardpolicy)
- [TransactionService Fix](./v0.6.7_agent-a.md#a2-fix-transactionservice-stale-port--chain_id)
- [Unit Tests](./v0.6.7_agent-a.md#a3-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.6.7_agent-b.md#scope)
- [Tasks](./v0.6.7_agent-b.md#tasks)
- [Pool-hub Settings](./v0.6.7_agent-b.md#b1-pool-hub-settings)
- [PoolHubBlockchainClient](./v0.6.7_agent-b.md#b2-poolhubblockchainclient)
- [Miner Registration](./v0.6.7_agent-b.md#b3-miner-registration-with-chain_id)
- [Reward Distribution](./v0.6.7_agent-b.md#b4-wire-reward-distribution-into-job-completion)
- [RewardPayout Model](./v0.6.7_agent-b.md#b5-rewardpayout-model)
- [Deprecation Notice](./v0.6.7_agent-b.md#b6-deprecate-srcapp-in-memory-implementation)
- [Integration Tests](./v0.6.7_agent-b.md#b7-integration-tests)
- [Dependency Graph](./v0.6.7_agent-b.md#dependency-graph)
- [Coordination](./v0.6.7_agent-b.md#coordination)
- [Success Criteria](./v0.6.7_agent-b.md#success-criteria)
