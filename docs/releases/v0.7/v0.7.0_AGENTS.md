...
>
> **Prerequisites**: [v0.6.0](../v0.6/v0.6.0_change.log) ✅, [v0.6.1](../v0.6/v0.6.1_change.log) ✅, [v0.6.3](../v0.6/v0.6.3_change.log) ✅, [v0.6.4](../v0.6/v0.6.4_change.log) ✅, [v0.5.16](../v0.5/v0.5.16_change.log) ✅. All technical prerequisites complete. v0.6.6/v0.6.7 (product track) are in progress but touch different code (marketplace/pool-hub) — no file conflicts with bridge work.
>
...
- **[Overview](./v0.7.0_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.7.0_agent-a.md)** - Shared core implementation (BridgeClient, bridge types, proof utilities, unit tests)
- **[Agent B Tasks](./v0.7.0_agent-b.md)** - Apps & infrastructure implementation (bridge config, RPC endpoints, CLI fixes, monitoring, tests)
...
- [Status Baseline](./v0.7.0_overview.md#status-baseline--verified-code-targets)
- [Already Fixed / Exists](./v0.7.0_overview.md#already-fixed--exists-verified--no-work-needed)
- [Architecture](./v0.7.0_overview.md#architecture-bridge-basics-v070)
- [Task Split Overview](./v0.7.0_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.7.0_agent-a.md#scope)
- [Tasks](./v0.7.0_agent-a.md#tasks)
- [BridgeClient + Bridge Types](./v0.7.0_agent-a.md#a1-bridgeclient--bridge-types)
- [Proof Utilities](./v0.7.0_agent-a.md#a2-proof-utilities)
- [Unit Tests](./v0.7.0_agent-a.md#a3-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.0_agent-b.md#scope)
- [Tasks](./v0.7.0_agent-b.md#tasks)
- [Bridge Config + Constants](./v0.7.0_agent-b.md#b1-bridge-config--constants)
- [Missing RPC Endpoints](./v0.7.0_agent-b.md#b2-missing-rpc-endpoints)
- [Fix CLI Bridge Commands](./v0.7.0_agent-b.md#b3-fix-cli-bridge-commands)
- [Bridge Monitoring](./v0.7.0_agent-b.md#b4-bridge-monitoring)
- [CLI Node Bridge Commands](./v0.7.0_agent-b.md#b5-cli-node-bridge-commands)
- [Integration Tests](./v0.7.0_agent-b.md#b6-integration-tests)
- [Verification](./v0.7.0_agent-b.md#b7-verification)
- [Coordination Protocol](./v0.7.0_agent-b.md#coordination-protocol)
