...
>
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) — Bridge Basics. v0.7.0 Agent A (shared bridge SDK) is ✅ committed (`35b029852`). v0.7.0 Agent B (RPC endpoints, CLI, monitoring, tests) exists in the working tree but is **uncommitted** — Agent B must commit v0.7.0 work before starting v0.7.1. [v0.5.16](../v0.5/v0.5.16_change.log) ✅ (bridge proof hardening + release fence).
>
...
- **[Overview](./v0.7.1_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.7.1_agent-a.md)** - Shared core implementation (bridge types extension, multi-sig utilities, validator set registry, BridgeClient extensions, unit tests)
- **[Agent B Tasks](./v0.7.1_agent-b.md)** - Apps & infrastructure implementation (threat model, config, block header signatures, validator table, RPC endpoints, multi-sig bridge upgrade, CLI, integration tests)
...
- [Status Baseline](./v0.7.1_overview.md#status-baseline--verified-code-targets-from-subagent-investigation-2026-06-29)
- [Already Fixed / Exists](./v0.7.1_overview.md#already-fixed--exists-verified--no-work-needed)
- [Architecture](./v0.7.1_overview.md#architecture-bridge-security-v071)
- [Task Split Overview](./v0.7.1_overview.md#task-split-overview)
- [Phase 0 - Threat Model](./v0.7.1_overview.md#phase-0--threat-model-prerequisite)

### Agent A (Shared Core)

- [Scope](./v0.7.1_agent-a.md#scope)
- [Tasks](./v0.7.1_agent-a.md#tasks)
- [Extend Bridge Types](./v0.7.1_agent-a.md#a1-extend-bridge-types)
- [Multi-Sig Utilities](./v0.7.1_agent-a.md#a2-multi-sig-utilities)
- [Validator Set Registry](./v0.7.1_agent-a.md#a3-validator-set-registry)
- [BridgeClient Extensions + Unit Tests](./v0.7.1_agent-a.md#a4-bridgeclient-extensions--unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.1_agent-b.md#scope)
- [Tasks](./v0.7.1_agent-b.md#tasks)
- [Threat Model Document](./v0.7.1_agent-b.md#b1-threat-model-document)
- [Bridge Security Config + Constants](./v0.7.1_agent-b.md#b2-bridge-security-config--constants)
- [Block Header Signatures](./v0.7.1_agent-b.md#b3-block-header-signatures)
- [BridgeValidator SQLModel Table](./v0.7.1_agent-b.md#b4-bridgevalidator-sqlmodel-table)
- [Validator RPC Endpoints](./v0.7.1_agent-b.md#b5-validator-rpc-endpoints)
- [Upgrade Bridge Proof Verification to Multi-Sig](./v0.7.1_agent-b.md#b6-upgrade-bridge-proof-verification-to-multi-sig)
- [CLI Commands](./v0.7.1_agent-b.md#b7-cli-commands)
- [Integration Tests](./v0.7.1_agent-b.md#b8-integration-tests)
