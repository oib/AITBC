...
>
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) ✅ (Agent A committed), [v0.7.1](../v0.7/v0.7.1_change.log) (Agent A ✅ committed, Agent B 🔴 not started), [v0.5.16](../v0.5/v0.5.16_change.log) ✅ (bridge proof hardening + release fence).
...
- **[Overview](./v0.7.2_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.7.2_agent-a.md)** - Shared core implementation (verification types, oracle interface, verification utilities, BridgeClient extensions, unit tests)
- **[Agent B Tasks](./v0.7.2_agent-b.md)** - Apps & infrastructure implementation (verification config, block header storage, Merkle proof verification, block header verification, finality tracking, validator epoch tracking, unfence release path, CLI, integration tests)
...
- [Status Baseline](./v0.7.2_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Already Fixed / Exists](./v0.7.2_overview.md#already-fixed--exists-verified--no-work-needed)
- [Hard Blockers](./v0.7.2_overview.md#hard-blockers-must-be-resolved-before-v072-implementation)
- [Architecture](./v0.7.2_overview.md#architecture-bridge-verification-v072)
- [Task Split Overview](./v0.7.2_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.7.2_agent-a.md#scope)
- [Tasks](./v0.7.2_agent-a.md#tasks)
- [Extend Bridge Types](./v0.7.2_agent-a.md#a1-extend-bridge-types)
- [Oracle Client Interface](./v0.7.2_agent-a.md#a2-oracle-client-interface)
- [Verification Utilities](./v0.7.2_agent-a.md#a3-verification-utilities)
- [BridgeClient Extensions + Unit Tests](./v0.7.2_agent-a.md#a4-bridgeclient-extensions--unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.2_agent-b.md#scope)
- [Tasks](./v0.7.2_agent-b.md#tasks)
- [Bridge Verification Config + Constants](./v0.7.2_agent-b.md#b1-bridge-verification-config--constants)
- [Remote Block Header Storage](./v0.7.2_agent-b.md#b2-remote-block-header-storage)
- [Merkle Proof Verification](./v0.7.2_agent-b.md#b3-merkle-proof-verification)
- [Block Header Signature Verification](./v0.7.2_agent-b.md#b4-block-header-signature-verification)
- [Finality Tracking](./v0.7.2_agent-b.md#b5-finality-tracking)
- [Validator Set Epoch Tracking](./v0.7.2_agent-b.md#b6-validator-set-epoch-tracking)
- [Unfence Release Path + CLI](./v0.7.2_agent-b.md#b7-unfence-release-path--cli)
- [Integration Tests](./v0.7.2_agent-b.md#b8-integration-tests)
