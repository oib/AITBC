...
>
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅ (Agent A `1fcf1e829` + Agent B `a4ea61295`), [v0.7.2](../v0.7/v0.7.2_change.log) (Agent A ✅ `9a7b17a34`, Agent B 🔴 in progress), [v0.6.7](../v0.6/v0.6.7_change.log) ✅ (`5bb3803bd`), [v0.5.16](../v0.5/v0.5.16_change.log) ✅.
>
...
- **[Overview](./v0.7.3_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.7.3_agent-a.md)** - Shared core implementation (governance types, client, on-chain utilities)
- **[Agent B Tasks](./v0.7.3_agent-b.md)** - Apps & infrastructure implementation (governance service config, blockchain tx types, CLI)
...
- [Status Baseline](./v0.7.3_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.7.3_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.7.3_agent-a.md#scope)
- [Tasks](./v0.7.3_agent-a.md#tasks)
- [Governance types](./v0.7.3_agent-a.md#a1-governance-types)
- [Governance client](./v0.7.3_agent-a.md#a2-governance-client)
- [On-chain utilities](./v0.7.3_agent-a.md#a3-on-chain-utilities)
- [Unit tests](./v0.7.3_agent-a.md#a4-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.3_agent-b.md#scope)
- [Tasks](./v0.7.3_agent-b.md#tasks)
- [Governance config](./v0.7.3_agent-b.md#b1-governance-config)
- [Blockchain client](./v0.7.3_agent-b.md#b2-blockchain-client)
- [On-chain proposals](./v0.7.3_agent-b.md#b3-on-chain-proposals)
- [On-chain voting](./v0.7.3_agent-b.md#b4-on-chain-voting)
- [Timelock execution](./v0.7.3_agent-b.md#b5-timelock-execution)
- [Tests](./v0.7.3_agent-b.md#b6-tests)
- [Governance tx types](./v0.7.3_agent-b.md#b7-governance-tx-types)
- [Governance tx payload validation](./v0.7.3_agent-b.md#b8-governance-tx-payload-validation)
- [CLI commands](./v0.7.3_agent-b.md#b9-cli-commands)
