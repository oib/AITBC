...
>
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅, [v0.7.2](../v0.7/v0.7.2_change.log) ✅ (Agent A `9a7b17a34`), [v0.7.3](../v0.7/v0.7.3_change.log) (Agent A ✅ `923e0a5bc`).
>
...
- **[Overview](./v0.7.4_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.7.4_agent-a.md)** - Shared core implementation (ExternalOracleClient, oracle fallback, cross-chain governance)
- **[Agent B Tasks](./v0.7.4_agent-b.md)** - Apps & infrastructure implementation (oracle config, governance endpoints, parameter APIs, MultiValidatorPoA)
...
- [Status Baseline](./v0.7.4_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.7.4_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.7.4_agent-a.md#scope)
- [Tasks](./v0.7.4_agent-a.md#tasks)
- [ExternalOracleClient](./v0.7.4_agent-a.md#a1-externaloracleclient)
- [Oracle Fallback Policy](./v0.7.4_agent-a.md#a2-oracle-fallback-policy)
- [Cross-Chain Governance Utilities](./v0.7.4_agent-a.md#a3-cross-chain-governance-utilities)
- [Parameter Change Execution](./v0.7.4_agent-a.md#a4-parameter-change-execution)
- [Unit Tests](./v0.7.4_agent-a.md#a5-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.4_agent-b.md#scope)
- [Tasks](./v0.7.4_agent-b.md#tasks)
- [Oracle Config](./v0.7.4_agent-b.md#b1-oracle-config)
- [Cross-Chain Governance Endpoints](./v0.7.4_agent-b.md#b2-cross-chain-governance-endpoints)
- [Pool-Hub Parameter API](./v0.7.4_agent-b.md#b3-pool-hub-parameter-api)
- [Marketplace Parameter API](./v0.7.4_agent-b.md#b4-marketplace-parameter-api)
- [Emergency Proposal Handling](./v0.7.4_agent-b.md#b5-emergency-proposal-handling)
- [Coordinator-API Bridge Integration](./v0.7.4_agent-b.md#b6-integrate-coordinator-api-with-bridgeclient)
- [MultiValidatorPoA Activation](./v0.7.4_agent-b.md#b7-multivalidatorpoa-activation--deferred-to-v075)
- [CLI Commands](./v0.7.4_agent-b.md#b8-add-cli-commands)
- [Integration Tests](./v0.7.4_agent-b.md#b9-integration-tests)
...
⛔ **Security review complete — DO NOT ACTIVATE in v0.7.4.** See [security-review-multivalidator-poa.md](v0.7.4_security-review-multivalidator-poa.md).
