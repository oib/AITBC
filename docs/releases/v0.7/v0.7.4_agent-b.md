...
- Security review findings documented in `docs/releases/v0.7/v0.7.4_security-review-multivalidator-poa.md`
...
- [Overview](./v0.7.4_overview.md) - Release overview and status baseline
