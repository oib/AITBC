...
**Goal**: Transform the scaffolding MultiValidatorPoA and PBFT implementations into production-grade consensus, satisfying all gating criteria from the [security review](../v0.7/v0.7.4_security-review-multivalidator-poa.md), then remove the RuntimeError guards and activate multi-validator consensus.

> **Prerequisites**: [v0.7.4](../v0.7/v0.7.4_change.log) ✅ (Agent A `feat(v0.7.4-a)`, Agent B pending — but v0.7.5 Agent A only needs v0.7.2/v0.7.3 which are ✅).
>
...
- **[Overview](./v0.7.5_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.7.5_agent-a.md)** - Shared core implementation (consensus signing utilities, shared types)
- **[Agent B Tasks](./v0.7.5_agent-b.md)** - Apps & infrastructure implementation (security fixes, consensus activation, tests)
...
- [Status Baseline](./v0.7.5_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.7.5_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.7.5_agent-a.md#scope)
- [Tasks](./v0.7.5_agent-a.md#tasks)
- [Consensus Signing Utilities](./v0.7.5_agent-a.md#a1-consensus-signing-utilities)
- [Shared Consensus Types](./v0.7.5_agent-a.md#a2-shared-consensus-types)
- [Unit Tests](./v0.7.5_agent-a.md#a3-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.7.5_agent-b.md#scope)
- [Tasks](./v0.7.5_agent-b.md#tasks)
- [Config](./v0.7.5_agent-b.md#b1-config)
- [KeyManager rewrite](./v0.7.5_agent-b.md#b2-keymanager-rewrite-to-secp256k1)
- [MultiValidatorPoA fixes](./v0.7.5_agent-b.md#b3-multivalidatorpoa-fixes)
- [PBFT fixes](./v0.7.5_agent-b.md#b4-pbft-fixes)
- [SlashingManager wiring](./v0.7.5_agent-b.md#b5-wire-slashingmanager-into-multivalidatorpoa)
- [ValidatorRotation wiring](./v0.7.5_agent-b.md#b6-wire-validatorrotation-into-multivalidatorpoa)
- [Gossip-based PBFT transport](./v0.7.5_agent-b.md#b7-gossip-based-pbft-transport)
- [Validator persistence](./v0.7.5_agent-b.md#b8-validator-persistence)
- [Metrics](./v0.7.5_agent-b.md#b9-metrics)
- [CLI commands](./v0.7.5_agent-b.md#b10-cli-commands)
- [Tests](./v0.7.5_agent-b.md#b11-tests)
- [Testnet soak test](./v0.7.5_agent-b.md#b12-testnet-soak-test)
- [Mainnet activation](./v0.7.5_agent-b.md#b13-mainnet-activation)
- [Documentation](./v0.7.5_agent-b.md#b14-documentation)
