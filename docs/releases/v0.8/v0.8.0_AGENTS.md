...
>
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅, [v0.7.2](../v0.7/v0.7.2_change.log) ✅, [v0.6.3](../v0.6/v0.6.3_change.log) ✅, [v0.6.4](../v0.6/v0.6.4_change.log) ✅, [v0.6.6](../v0.6/v0.6.6_change.log) ✅, [v0.6.7](../v0.6/v0.6.7_change.log) ✅.
>
...
- **[Overview](./v0.8.0_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.8.0_agent-a.md)** - Shared core implementation (trading types, trading client, bridge integration, unit tests)
- **[Agent B Tasks](./v0.8.0_agent-b.md)** - Apps & infrastructure implementation (trading config, domain models, RPC clients, chain discovery, trade lifecycle, matching engine, CLI, integration tests)
...
- [Status Baseline](./v0.8.0_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Already Fixed / Exists](./v0.8.0_overview.md#already-fixed--exists-verified--no-work-needed)
- [Architecture](./v0.8.0_overview.md#architecture-inter-chain-trading-v080)
- [Task Split Overview](./v0.8.0_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.8.0_agent-a.md#scope)
- [Tasks](./v0.8.0_agent-a.md#tasks)
- [Trading Types](./v0.8.0_agent-a.md#a1-trading-types)
- [Trading Client](./v0.8.0_agent-a.md#a2-trading-client)
- [Bridge Integration Utilities](./v0.8.0_agent-a.md#a3-bridge-integration-utilities)
- [Unit Tests](./v0.8.0_agent-a.md#a4-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.8.0_agent-b.md#scope)
- [Tasks](./v0.8.0_agent-b.md#tasks)
- [Trading Service Config](./v0.8.0_agent-b.md#b1-trading-service-config)
- [Inter-Chain Domain Models](./v0.8.0_agent-b.md#b2-inter-chain-domain-models)
- [Blockchain/Bridge RPC Client](./v0.8.0_agent-b.md#b3-blockchainbridge-rpc-client)
- [Chain Discovery](./v0.8.0_agent-b.md#b4-chain-discovery)
- [Inter-Chain Trade Lifecycle](./v0.8.0_agent-b.md#b5-inter-chain-trade-lifecycle)
- [Basic Matching Engine](./v0.8.0_agent-b.md#b6-basic-matching-engine)
- [CLI Trade Command Group](./v0.8.0_agent-b.md#b7-cli-trade-command-group)
- [Integration Tests](./v0.8.0_agent-b.md#b8-integration-tests)
