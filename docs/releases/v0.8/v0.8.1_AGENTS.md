...
>
> **Prerequisites**: [v0.8.0](../v0.8/v0.8.0_change.log) (Agent A ✅ `939bb066f`, Agent B ⬜ pending), [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅, [v0.7.2](../v0.7/v0.7.2_change.log) ✅, [v0.6.6](../v0.6/v0.6.6_change.log) ✅ (Marketplace + OfferFSM + BlockchainRPCClient).
>
...
- **[Overview](./v0.8.1_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.8.1_agent-a.md)** - Shared core implementation (offer sync types, client, cache)
- **[Agent B Tasks](./v0.8.1_agent-b.md)** - Apps & infrastructure implementation (sync service, endpoints, CLI, tests)
...
- [Status Baseline](./v0.8.1_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.8.1_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.8.1_agent-a.md#scope)
- [Tasks](./v0.8.1_agent-a.md#tasks)
- [Offer sync types](./v0.8.1_agent-a.md#a1-offer-sync-types)
- [Offer sync client](./v0.8.1_agent-a.md#a2-offer-sync-client)
- [Offer cache](./v0.8.1_agent-a.md#a3-offer-cache)
- [Unit tests](./v0.8.1_agent-a.md#a4-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.8.1_agent-b.md#scope)
- [Tasks](./v0.8.1_agent-b.md#tasks)
- [Offer sync config](./v0.8.1_agent-b.md#b1-offer-sync-config)
- [Offer sync service](./v0.8.1_agent-b.md#b2-offer-sync-service)
- [Discovery endpoint](./v0.8.1_agent-b.md#b3-discovery-endpoint)
- [Sync endpoints](./v0.8.1_agent-b.md#b4-sync-endpoints)
- [CLI commands](./v0.8.1_agent-b.md#b5-cli-commands)
- [Tests](./v0.8.1_agent-b.md#b6-tests)
