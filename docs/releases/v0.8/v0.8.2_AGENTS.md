...
>
> **Prerequisites**: [v0.8.1](../v0.8/v0.8.1_change.log) (Agent A ✅ `b3f3ef57d`, Agent B ⬜ pending), [v0.8.0](../v0.8/v0.8.0_change.log), [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅, [v0.7.2](../v0.7/v0.7.2_change.log) ✅.
>
...
- **[Overview](./v0.8.2_overview.md)** - Release overview, status baseline, and task split overview
- **[Agent A Tasks](./v0.8.2_agent-a.md)** - Shared core implementation (offer event types, subscription client, search index)
- **[Agent B Tasks](./v0.8.2_agent-b.md)** - Apps & infrastructure implementation (WebSocket endpoints, gossip integration, CLI, tests)
...
- [Status Baseline](./v0.8.2_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Task Split Overview](./v0.8.2_overview.md#task-split-overview)

### Agent A (Shared Core)

- [Scope](./v0.8.2_agent-a.md#scope)
- [Tasks](./v0.8.2_agent-a.md#tasks)
- [Offer event types](./v0.8.2_agent-a.md#a1-offer-event-types)
- [Offer subscription client](./v0.8.2_agent-a.md#a2-offer-subscription-client)
- [Search index integration](./v0.8.2_agent-a.md#a3-search-index-integration-optional)
- [Unit tests](./v0.8.2_agent-a.md#a4-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.8.2_agent-b.md#scope)
- [Tasks](./v0.8.2_agent-b.md#tasks)
- [Offer event publishing](./v0.8.2_agent-b.md#b1-offer-event-publishing)
- [Offer WebSocket endpoint](./v0.8.2_agent-b.md#b2-offer-websocket-endpoint)
- [Gossip integration](./v0.8.2_agent-b.md#b3-gossip-integration)
- [Subscription endpoints](./v0.8.2_agent-b.md#b4-subscription-endpoints)
- [CLI commands](./v0.8.2_agent-b.md#b5-cli-commands)
- [Tests](./v0.8.2_agent-b.md#b6-tests)
