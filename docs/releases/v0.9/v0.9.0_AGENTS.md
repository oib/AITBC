...
> **Prerequisites**: [v0.7.0](../v0.7/v0.7.0_change.log) ✅, [v0.7.1](../v0.7/v0.7.1_change.log) ✅, [v0.7.2](../v0.7/v0.7.2_change.log) ✅, [v0.8.0](../v0.8/v0.8.0_change.log) ✅, [v0.8.1](../v0.8/v0.8.1_change.log) ✅, [v0.8.2](../v0.8/v0.8.2_change.log) ✅. v0.7.4 (oracle fallback) ✅ Agent A. v0.7.5 (consensus) not required — single-validator PoA remains active.
>
...
- **[Overview](./v0.9.0_overview.md)** - Release overview, status baseline, architecture, and task split overview
- **[Agent A Tasks](./v0.9.0_agent-a.md)** - Shared core implementation (settlement types, HTLC utilities, settlement client, proof chaining, trading types extension, unit tests)
- **[Agent B Tasks](./v0.9.0_agent-b.md)** - Apps & infrastructure implementation (escrow config, tables, settlement service, HTLC integration, RPC endpoints, trading endpoints, InterChainTrade model, coordinator, CLI, bridge confirm, chaos testing, integration tests)
...
- [Status Baseline](./v0.9.0_overview.md#status-baseline--verified-code-targets-2026-06-29)
- [Already Implemented](./v0.9.0_overview.md#already-implemented-reusable-no-work-needed)
- [Task Split Overview](./v0.9.0_overview.md#task-split-overview)
- [Coordination](./v0.9.0_overview.md#coordination)
- [Risk Mitigation](./v0.9.0_overview.md#risk-mitigation)
- [Fallback for v1.0.0](./v0.9.0_overview.md#fallback-for-v100)

### Agent A (Shared Core)

- [Scope](./v0.9.0_agent-a.md#scope)
- [Tasks](./v0.9.0_agent-a.md#tasks)
- [Settlement Types](./v0.9.0_agent-a.md#a1-settlement-types)
- [HTLC Utilities](./v0.9.0_agent-a.md#a2-htlc-utilities)
- [Settlement Client](./v0.9.0_agent-a.md#a3-settlement-client)
- [Proof Chaining](./v0.9.0_agent-a.md#a4-proof-chaining)
- [Extend Trading Types](./v0.9.0_agent-a.md#a5-extend-trading-types)
- [Unit Tests](./v0.9.0_agent-a.md#a6-unit-tests)

### Agent B (Apps & Infrastructure)

- [Scope](./v0.9.0_agent-b.md#scope)
- [Tasks](./v0.9.0_agent-b.md#tasks)
- [Escrow Config](./v0.9.0_agent-b.md#b1-escrow-config)
- [Escrow Tables](./v0.9.0_agent-b.md#b2-escrow-tables)
- [CrossChainSettlementService](./v0.9.0_agent-b.md#b3-crosschainsettlementservice)
- [HTLC Contract Integration](./v0.9.0_agent-b.md#b4-htlc-contract-integration)
- [Settlement RPC Endpoints](./v0.9.0_agent-b.md#b5-settlement-rpc-endpoints)
- [Trading Service Settlement Endpoints](./v0.9.0_agent-b.md#b6-trading-service-settlement-endpoints)
- [Extend InterChainTrade Model](./v0.9.0_agent-b.md#b7-extend-interchain-trade-model)
- [Atomic Settlement Coordinator](./v0.9.0_agent-b.md#b8-atomic-settlement-coordinator)
- [CLI Commands](./v0.9.0_agent-b.md#b9-cli-commands)
- [Enable Bridge Confirm Path](./v0.9.0_agent-b.md#b10-enable-bridge-confirm-path)
- [Chaos Testing Infrastructure](./v0.9.0_agent-b.md#b11-chaos-testing-infrastructure)
- [Integration Tests](./v0.9.0_agent-b.md#b12-integration-tests)
