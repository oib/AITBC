...
- [ ] **Bash scripts >100 lines** → MANDATORY System Architect review
  ...
  - AITBC-XXX Gap: 710-line `deploy-migration-prod.sh` delivered without review

- [ ] **CI/CD workflow created/modified** → MANDATORY System Architect review
  - Example: GitHub Actions workflows, pipeline changes
  - AITBC-XXX Gap: 641-line `migration-validation.yml` delivered without review
...
- [ ] **Validation/verification scripts >200 lines** → MANDATORY System Architect review
  ...
  - AITBC-XXX Gap: 3 TypeScript scripts delivered without review
...
- [ ] Branch naming: `AITBC-{number}-{description}` or `AITBC-{number}-{description}`
- [ ] Commit messages: SAFe format with ticket reference
  - Format: `type(scope): description [AITBC-XXX]`
  - Types: feat, fix, docs, style, refactor, test, chore
- [ ] Rebase onto latest `dev` or `main` (no merge commits)
...
## Example: AITBC-321 Failure Analysis
...
**This checklist prevents architectural governance gaps like AITBC-321**
