...
3. **AITBC Methodology** - Evidence-Based, Pattern-Driven, Spec-Driven
...
1. **Specs Directory**: `ls specs/AITBC-*-spec.md | grep "similar"`
...
```bash
cp specs/planning_template.md specs/AITBC-XXX-{initiative}-planning.md
```
