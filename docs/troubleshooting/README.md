...
This directory contains troubleshooting guides for common issues encountered when deploying and operating the AITBC platform.

## Troubleshooting Guides

- [Service Management](service-management.md) - Service startup, configuration, permissions, and resource monitoring
...
- [Performance Issues](performance-issues.md) - High CPU, memory, disk I/O, and latency issues
- [Security Issues](security-issues.md) - Authentication, API key, and access control problems

## Getting Help

For additional support, see the [Getting Help](security-issues.md#getting-help) section in the security issues guide.
