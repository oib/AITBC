...
**CRITICAL UPDATE (v1.1)**: Based on AITBC-321 gap discovery, System Architect review is **MANDATORY** for complex code.
...
Task({
  ...
  description: "Review AITBC-XXX automation scripts",
...
**AITBC-321 Lesson**: Correct specialist selection, but MISSING System Architect review
...
## Role Collapsing Authority (AITBC-499)
...
- **Added**: Role Collapsing Authority section (AITBC-499)
...
- **Added**: AITBC-321 retrospective and gap analysis
- **Added**: Pattern 3 (Complex Automation with MANDATORY review)
- **Rationale**: Prevent AITBC-321-type gaps (unreviewed complex code)
