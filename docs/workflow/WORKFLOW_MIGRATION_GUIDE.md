...
**Date**: 2025-10-06
**Audience**: Development teams working on AITBC-app
...
3. **WAIT FOR TDM PRE-GATE** 👈 NEW
   - TDM verifies branch naming: AITBC-XXX-...
...
# Must be: AITBC-{number}-{description}
# Example: AITBC-321-free-tools-bonus
...
- Required: AITBC-XXX-free-tools-bonus
...
- Make atomic commits: `type(scope): description [AITBC-XXX]`
...
```sql
PR created → Scott reviews → oib merges
```text
...
- [x] Branch: AITBC-321-free-tools-bonus
