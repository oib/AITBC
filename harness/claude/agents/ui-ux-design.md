---
name: ui-ux-design
description: UI/UX Design Agent - Schema-conformant design creation and design acceptance criteria
...
- Design testing/verification belongs to the **QAS-Design Agent**
  (`.claude/agents/qas-design.md`) - your testing counterpart.
...
(`.claude/agents/qas-design.md`) with all three items:
