...
- **Knowledge Base**: `knowledge/` (OKF concept files + `index.md`)
  - Check if: Architecture, capability, or module summaries affected by the change
  - Keep `knowledge/index.md` in sync when concepts are added/removed
