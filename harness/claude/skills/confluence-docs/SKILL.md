...
description: Local Markdown documentation templates for ADRs, runbooks, and architecture docs, written into the repo's docs/ tree. Use when creating architectural decision records, operational runbooks, or technical documentation. Does not publish to Confluence or any MCP server.
...
The authoritative ADR index lives in `adrs/README.md`, split
across three levels: `adrs/agentic/` (boilerplate-governance, `ADR-A-nnnn`), `adrs/company/`
(`ADR-C-nnnn`), and `adrs/project/` (`ADR-P-nnnn`). Browse `adrs/agentic/` for the shipped
governance ADRs (e.g. `ADR-A-0001-three-level-adr-hierarchy.md`).
...
| -------------- | ------------------------------------ | -------------------------------------- |
| ADRs           | `adrs/`                          | `ADR-XXX-{description}.md`             |
| Runbooks       | `docs/runbooks/`                     | `{operation}-runbook.md`               |
| Architecture   | `docs/architecture/`                 | `{system}-architecture.md`             |
| KT Docs        | `docs/`                              | `KT-AITBC-XXX-{topic}.md`    |
| Technical Docs | `docs/agent-outputs/technical-docs/` | `AITBC-XXX-{description}.md` |
