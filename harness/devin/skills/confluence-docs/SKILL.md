...
description: Local Markdown documentation templates for ADRs, runbooks, and architecture
  docs, written into the repo's docs/ tree. Use when creating architectural decision
  records, operational runbooks, or technical documentation. Does not publish to Confluence
  or any MCP server.
triggers:
- user
- model
