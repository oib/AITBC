...
class TestExchangeRatesCommand:
    ...
    def test_rates_success(self, mock_client_class, runner, mock_config):
        ...
        mock_response.json.return_value = {"btc_to_aitbc": 100000, "aitbc_to_btc": 0.00001, "fee_percent": 0.5}
        mock_client.get.return_value = mock_response

        # Run command
        result = runner.invoke(exchange, ["rates"], obj={"config": mock_config, "output": "json"})
        ...
        # Verify API call
        mock_client.get.assert_called_once_with("http://test:8000/v1/exchange/rates", timeout=10)
...
class TestExchangeCreatePaymentCommand:
    ...
    def test_create_payment_with_aitbc_amount(self, mock_client_class, runner, mock_config):
        ...
        rates_response.json.return_value = {"btc_to_aitbc": 100000, "aitbc_to_btc": 0.00001, "fee_percent": 0.5}
        ...
        result = runner.invoke(
            exchange,
            ["create-payment", "--aitbc-amount", "1000", "--user-id", "test_user", "--notes", "Test payment"],
    ...
    def test_create_payment_with_btc_amount(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(
            exchange, ["create-payment", "--btc-amount", "0.005"], obj={"config": mock_config, "output": "json"}
        )
    ...
    def test_create_payment_no_amount(self, runner, mock_config):
        ...
        result = runner.invoke(exchange, ["create-payment"], obj={"config": mock_config, "output": "json"})
    ...
    def test_create_payment_invalid_aitbc_amount(self, runner, mock_config):
        ...
        result = runner.invoke(
            exchange, ["create-payment", "--aitbc-amount", "0"], obj={"config": mock_config, "output": "json"}
        )
    ...
    def test_create_payment_invalid_btc_amount(self, runner, mock_config):
        ...
        # Run command with invalid amount
        result = runner.invoke(
            exchange, ["create-payment", "--btc-amount", "-0.01"], obj={"config": mock_config, "output": "json"}
        )
...
class TestExchangePaymentStatusCommand:
    ...
    def test_payment_status_pending(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(
            exchange, ["payment-status", "--payment-id", "pay_123456"], obj={"config": mock_config, "output": "json"}
        )
        ...
        # Verify API call
        mock_client.get.assert_called_once_with("http://test:8000/v1/exchange/payment-status/pay_123456", timeout=10)
    ...
    def test_payment_status_not_found(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(
            exchange, ["payment-status", "--payment-id", "nonexistent"], obj={"config": mock_config, "output": "json"}
        )
...
class TestExchangeMarketStatsCommand:
    ...
    def test_market_stats_success(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(exchange, ["market-stats"], obj={"config": mock_config, "output": "json"})
        ...
        # Verify API call
        mock_client.get.assert_called_once_with("http://test:8000/v1/exchange/market-stats", timeout=10)
...
class TestExchangeWalletCommands:
    ...
    def test_wallet_balance_success(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(exchange, ["wallet", "balance"], obj={"config": mock_config, "output": "json"})
        ...
        # Verify API call
        mock_client.get.assert_called_once_with("http://test:8000/v1/exchange/wallet/balance", timeout=10)
    ...
    def test_wallet_info_success(self, mock_client_class, runner, mock_config):
        ...
        # Run command
        result = runner.invoke(exchange, ["wallet", "info"], obj={"config": mock_config, "output": "json"})
        ...
        # Verify API call
        mock_client.get.assert_called_once_with("http://test:8000/v1/exchange/wallet/info", timeout=10)
...
class TestExchangeIntegration:
    ...
    def test_complete_exchange_workflow(self, mock_client_class, runner, mock_config):
        ...
        # Execute workflow
        # Get rates
        result1 = runner.invoke(exchange, ["rates"], obj={"config": mock_config, "output": "json"})
        assert result1.exit_code == 0

        # Create payment
        result2 = runner.invoke(
            exchange, ["create-payment", "--aitbc-amount", "1000"], obj={"config": mock_config, "output": "json"}
        )
        assert result2.exit_code == 0

        # Check payment status
        result3 = runner.invoke(
            exchange, ["payment-status", "--payment-id", "pay_workflow_123"], obj={"config": mock_config, "output": "json"}
        )
