...
class MarketOffer(SQLModel, table=True):
    """Market offer for GPU/compute resources"""
...
class MarketBid(SQLModel, table=True):
    """Bid on a market offer"""
    ...
    @classmethod
    def with_table_name(cls, table_name: str) -> type[MarketBid]:
