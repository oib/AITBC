#!/usr/bin/env python3
"""
Advanced Market Database Setup Script

Creates and verifies advanced market feature database tables.
Run this script to initialize the database for advanced market features.

Usage:
    python scripts/migration/create_advanced_market_tables.py              # Create tables (idempotent)
    python scripts/migration/create_advanced_market_tables.py --verify    # Verify tables exist
    python scripts/migration/create_advanced_market_tables.py --reset     # Drop and recreate (WARNING: data loss)
"""
...
def verify_tables(db_path):
    """Verify all advanced market tables exist in the database."""
    expected_tables = [
        "price_history",
        "price_forecast",
        "auction_config",
    ...
    if missing_tables:
        ...
        print("✓ All advanced market tables exist")
        return True


def create_tables(reset=False):
    """Create all advanced market database tables using SQLite."""
    print("Creating advanced market database tables...")
    ...
    try:
        ...
        print("✓ All advanced market tables created successfully")
        print("\nCreated tables:")
        print("  - price_history")
...
def main():
    parser = argparse.ArgumentParser(
        description="Advanced Market Database Setup Script",
