#!/usr/bin/env python3
"""
Migration script: Convert plugin service JSON data to market service database
Migrates /var/lib/aitbc/plugins.json to SoftwareService table in market database
"""
...
sys.path.insert(0, str(Path("/opt/aitbc/apps/market/src")))
...
async def migrate_to_database(plugin_data):
    """Migrate plugin data to market database"""
