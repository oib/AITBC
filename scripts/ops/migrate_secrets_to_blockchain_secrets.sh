...
for var in REDIS_URL GOSSIP_BROADCAST_URL SYNC_REDIS_URL API_KEY_HASH_SECRET BLOCKCHAIN_RPC_API_KEY COORDINATOR_API_KEY SECRET_KEY JWT_SECRET PROPOSER_KEY GENESIS_PRIVATE_KEY VALIDATOR_KEYS BLOCKCHAIN_API_KEY; do
