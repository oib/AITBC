...
class ChaosTestNetwork:
    ...
    async def run_test(self, partition_duration: int = 60, partition_ratio: float = 0.5):
        ...
        self.metrics["partition_start"] = datetime.now(UTC).isoformat()
        ...
        self.metrics["partition_end"] = datetime.now(UTC).isoformat()
        ...
        # Final metrics
        self.metrics["test_end"] = datetime.now(UTC).isoformat()
