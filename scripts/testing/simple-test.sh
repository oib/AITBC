...
echo "GPU Multimodal (8203): $(curl -s http://localhost:8203/health | jq -r .status 2>/dev/null || echo 'FAIL')"
...
echo ""
echo "📊 Port Usage:"
sudo netstat -tlnp | grep -E ":(8000|8001|8003|8010|8203|8012|8013|8017)" | sort
