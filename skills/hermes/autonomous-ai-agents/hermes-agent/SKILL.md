...
The agent's personality and operating style is defined in `~/.hermes/SOUL.md`. This file is loaded fresh each message and injected into the system prompt.

**Key path**: `~/.hermes/SOUL.md`
