...
| ------ | ------ | ------- | ------ | ------------ |
| {{STREAM_1}} | {{PTS}} | AITBC-XXX–YYY | Not Started | S1-S3 |
| {{STREAM_2}} | {{PTS}} | AITBC-XXX–YYY | Not Started | S4-S6 |
| {{STREAM_3}} | {{PTS}} | AITBC-XXX–YYY | Not Started | S5-S8 |
...
| -- | ----------- | --- | ---- | ------------ | ----- |
| AITBC-XXX | {{DESCRIPTION}} | {{PTS}} | {{TEAM}} | — | |
| AITBC-XXX | {{DESCRIPTION}} | {{PTS}} | {{TEAM}} | {{DEP}} | |
...
| ---- | ------ | ---------- | ------ | ----- |
| {{TEAM_1}} | {{PREFIX}} | AITBC-XXX/YYY | {{PTS}} | {{SCOPE}} |
| {{TEAM_2}} | {{PREFIX}} | AITBC-XXX/YYY | {{PTS}} | {{SCOPE}} |
...
| -- | ----- | --- | ----- | ------ | ------------ |
| AITBC-XXX | {{TITLE}} | {{PTS}} | 1 | S4 | — |
| AITBC-XXX | {{TITLE}} | {{PTS}} | 1 | S5 | {{DEP}} |

### {{SERVICE_2}} Enablers ({{COUNT}} stories, {{PTS}} pts)

| ID | Title | Pts | Phase | Sprint | Dependencies |
| -- | ----- | --- | ----- | ------ | ------------ |
| AITBC-XXX | {{TITLE}} | {{PTS}} | 1-2 | S5-S6 | — |
...
| ------ | ------ | ------- | ----- |
| {{STREAM}} | {{PTS}} | AITBC-XXX–YYY | {{PHASE}} |
...
Based on production PI Planning across 5 services, a full SAFe agent roster, ~800 story points._
