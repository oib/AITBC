...
class TestCoinRequestsCommands:
    ...
    def test_coin_requests_group_exists(self):
        ...
        pytest.skip("Coin requests commands have complex agent service and DB dependencies")
    ...
    def test_coin_requests_list_command(self):
        """Test coin_requests list command - skip due to complex agent service dependencies"""
        pytest.skip("Coin requests commands have complex agent service and DB dependencies")
