"""
GPU Market Commands Tests
Tests for gpu_market CLI commands
...
class TestGPUMarketCommands:
    ...
    @patch("aitbc_cli.commands.gpu_market.AITBCHTTPClient")
    @patch("aitbc_cli.commands.gpu_market.get_config")
