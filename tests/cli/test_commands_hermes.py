...
class TestHermesCommands:
    ...
    def test_hermes_request_coins_command_exists(self):
        """Test that hermes request-coins subcommand is registered"""
        assert "request-coins" in hermes.commands

    @patch("aitbc_cli.commands.hermes._resolve_wallet_address")
    @patch("aitbc_cli.commands.hermes.websockets")
    @patch("aitbc_cli.commands.hermes.get_config")
    @patch("aitbc_cli.commands.hermes.success")
    @patch("aitbc_cli.commands.hermes.error")
    def test_hermes_request_coins_auto_transfer(
    ...
    @patch("aitbc_cli.commands.hermes.success")
    @patch("aitbc_cli.commands.hermes.error")
    def test_hermes_request_coins_pending_approval(
        self, mock_error, mock_success, mock_config, mock_ws, mock_wallet
    ):
    ...
    @patch("aitbc_cli.commands.hermes.websockets")
    @patch("aitbc_cli.commands.hermes.get_config")
    def test_hermes_request_coins_no_wallet(self, mock_config, mock_ws, mock_wallet):
