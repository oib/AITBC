...
def temp_config_file():
    ...
    with tempfile.NamedTemporaryFile(mode="w", suffix=".yaml", delete=False) as f:
        config_data = {"coordinator_url": "http://test:8000", "api_key": "test_key", "timeout": 60}
...
class TestConfigCommands:
    ...
    def test_show_config(self, mock_get_config, runner, mock_config):
        ...
        result = runner.invoke(config, ["show"], obj={"config": mock_config, "output_format": "json"})
    ...
    def test_set_invalid_timeout(self, runner, mock_config):
        ...
        result = runner.invoke(
            config, ["set", "--key", "timeout", "--value", "invalid"], obj={"config": mock_config, "output_format": "json"}
        )
    ...
    def test_set_invalid_key(self, runner, mock_config):
        ...
        result = runner.invoke(
            config, ["set", "--key", "invalid_key", "--value", "value"], obj={"config": mock_config, "output_format": "json"}
        )
    ...
    def test_path_command(self, runner, mock_config, tmp_path):
        ...
        with runner.isolated_filesystem():
            result = runner.invoke(config, ["path"], obj={"config": mock_config, "output": "table"})
    ...
    def test_path_global(self, runner, mock_config):
        ...
        result = runner.invoke(config, ["path", "--global"], obj={"config": mock_config, "output": "table"})
    ...
    def test_edit_command(self, mock_run, runner, mock_config, tmp_path, monkeypatch):
        ...
        with runner.isolated_filesystem(temp_dir=tmp_path), patch("pathlib.Path.home", return_value=tmp_path):
            ...
            result = runner.invoke(config, ["edit"], obj={"config": mock_config, "output_format": "json"})
    ...
    def test_reset_config_cancelled(self, runner, mock_config, temp_config_file):
        ...
        with runner.isolated_filesystem(temp_dir=config_dir):
            ...
            result = runner.invoke(config, ["reset"], obj={"config": mock_config, "output_format": "json"}, input="n\n")
    ...
    def test_reset_config_confirmed(self, runner, mock_config, temp_config_file):
        ...
        with runner.isolated_filesystem(temp_dir=config_dir):
            ...
            result = runner.invoke(config, ["reset"], obj={"config": mock_config, "output": "table"}, input="y\n")
    ...
    def test_reset_no_config(self, runner, mock_config, tmp_path):
        ...
        with runner.isolated_filesystem(), patch("pathlib.Path.home", return_value=tmp_path):
            result = runner.invoke(config, ["reset"], obj={"config": mock_config, "output_format": "json"})
    ...
    def test_export_yaml(self, runner, mock_config, temp_config_file):
        ...
        with runner.isolated_filesystem(temp_dir=config_dir):
            ...
            result = runner.invoke(config, ["export", "--format", "yaml"], obj={"config": mock_config, "output": "table"})
    ...
    def test_export_json(self, runner, mock_config, temp_config_file):
        ...
        with runner.isolated_filesystem(temp_dir=config_dir):
            ...
            result = runner.invoke(config, ["export", "--format", "json"], obj={"config": mock_config, "output": "table"})
    ...
    def test_export_no_config(self, runner, mock_config, tmp_path):
        ...
        with runner.isolated_filesystem(), patch("pathlib.Path.home", return_value=tmp_path):
            result = runner.invoke(config, ["export"], obj={"config": mock_config, "output_format": "json"})
    ...
    def test_import_config_json(self, runner, mock_config, tmp_path):
        ...
        import_data = {"coordinator_url": "http://json:8000", "timeout": 60}
    ...
    def test_import_nonexistent_file(self, runner, mock_config):
        ...
        result = runner.invoke(
            config, ["import-config", "--file-path", "/nonexistent/file.yaml"], obj={"config": mock_config, "output_format": "json"}
        )
    ...
    def test_environments(self, runner, mock_config):
        ...
        result = runner.invoke(config, ["environments"], obj={"config": mock_config, "output": "table"})
    ...
    def test_profiles_list(self, runner, mock_config, tmp_path):
        ...
        with patch("pathlib.Path.home") as mock_home:
            ...
            result = runner.invoke(config, ["profiles", "list"], obj={"config": mock_config, "output": "table"})
    ...
    def test_profiles_delete_cancelled(self, runner, mock_config, tmp_path):
        ...
        with patch("pathlib.Path.home") as mock_home:
            ...
            result = runner.invoke(
                config, ["profiles", "delete", "--name", "keep_me"], obj={"config": mock_config, "output_format": "json"}, input="n\n"
            )
