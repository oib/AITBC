...
class TestResourceCommands:
    ...
    def test_resource_status_all(self, mock_http_client_class, mock_get_config, runner):
        ...
        result = runner.invoke(resource, ["status"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_status_specific(self, mock_http_client_class, mock_get_config, runner):
        ...
        mock_client = MagicMock()
        mock_http_client_class.return_value = mock_client
        mock_client.get.return_value = {"id": "res_123", "type": "gpu", "status": "allocated", "efficiency": "85.5%"}

        result = runner.invoke(resource, ["status", "--resource-id", "res_123"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_deallocate(self, mock_http_client_class, mock_get_config, runner):
        ...
        result = runner.invoke(resource, ["deallocate", "res_123", "--force"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_deallocate_force(self, mock_http_client_class, mock_get_config, runner):
        ...
        mock_client = MagicMock()
        mock_http_client_class.return_value = mock_client
        mock_client.post.return_value = {"resource_id": "res_123", "status": "deallocated"}
    ...
    def test_resource_deallocate_network_error(self, mock_http_client_class, mock_get_config, runner):
        ...
        result = runner.invoke(resource, ["deallocate", "--force", "res_123"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_allocate_experimental_warning(self, runner, mock_config):
        ...
        result = runner.invoke(
            resource, ["allocate", "--resource-type", "gpu", "--quantity", "4"], obj={"config": mock_config, "output": "table"}
        )
    ...
    def test_resource_list_experimental_warning(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["list"], obj={"config": mock_config, "output": "table"})
    ...
    def test_resource_release_experimental_warning(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["release", "res_123"], obj={"config": mock_config, "output": "table"})
    ...
    def test_resource_utilization_experimental_warning(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["utilization"], obj={"config": mock_config, "output": "table"})
    ...
    def test_resource_optimize_experimental_warning(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["optimize"], obj={"config": mock_config, "output": "table"})
    ...
    def test_resource_status_table_format(self, mock_http_client_class, mock_get_config, runner):
        ...
        mock_client = MagicMock()
        mock_http_client_class.return_value = mock_client
        mock_client.get.return_value = {"resources": [{"id": "res_1", "type": "gpu", "status": "allocated"}]}

        result = runner.invoke(resource, ["status"], obj={"config": mock_config, "output": "table"})
    ...
    def test_resource_deallocate_with_confirmation(self, mock_http_client_class, mock_get_config, runner):
        ...
        result = runner.invoke(resource, ["deallocate", "res_123"], obj={"config": mock_config, "output": "json"}, input="y\n")
    ...
    def test_resource_deallocate_cancelled(self, mock_http_client_class, mock_get_config, runner):
        ...
        result = runner.invoke(resource, ["deallocate", "res_123"], obj={"config": mock_config, "output": "json"}, input="n\n")
    ...
    def test_resource_deallocate_with_coordinator_api(self, runner, mock_config, coordinator_available):
        ...
        result = runner.invoke(
            resource, ["deallocate", "test_res_123", "--force"], obj={"config": mock_config, "output": "json"}
        )
    ...
    def test_resource_list_with_mock(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["list", "--mock", "--format", "json"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_release_with_mock(self, runner, mock_config):
        ...
        result = runner.invoke(resource, ["release", "test_res_123", "--mock"], obj={"config": mock_config, "output": "json"})
    ...
    def test_resource_utilization_with_mock(self, runner, mock_config):
        ...
        result = runner.invoke(
            resource, ["utilization", "--mock", "--format", "json"], obj={"config": mock_config, "output": "json"}
        )
    ...
    def test_resource_allocate_with_parameters(self, runner, mock_config):
        ...
        result = runner.invoke(
            resource,
            ["allocate", "--resource-type", "gpu", "--quantity", "8", "--priority", "high", "--mock"],
            obj={"config": mock_config, "output": "json"},
        )
    ...
    def test_resource_status_filter_by_type(self, runner, mock_config, coordinator_available):
        ...
        result = runner.invoke(resource, ["status", "--resource-type", "gpu"], obj={"config": mock_config, "output": "json"})
