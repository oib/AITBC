...
class TestDeriveSecureKey:
    ...
    def test_derive_secure_key_with_password(self):
        ...
        from aitbc.security.encryption import derive_secure_key
...
class TestEncryptValue:
    ...
    def test_encrypt_value(self):
        ...
        from aitbc.security.encryption import encrypt_value
...
class TestDecryptValue:
    ...
    def test_decrypt_value(self):
        ...
        from aitbc.security.encryption import decrypt_value, encrypt_value
...
class TestGenerateSecurePassword:
    ...
    def test_generate_secure_password_default(self):
        ...
        from aitbc.security.encryption import generate_secure_password, validate_password_strength
...
class TestMigrateLegacyWallet:
    ...
    def test_migrate_legacy_wallet_success(self):
        ...
        from aitbc.security.encryption import migrate_legacy_wallet
...
class TestEncryptionConfig:
    ...
    def test_encryption_config_constants(self):
        ...
        from aitbc.security.encryption import EncryptionConfig
