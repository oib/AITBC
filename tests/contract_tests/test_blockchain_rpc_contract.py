...
class TestBlockchainRPCContracts:
    ...
    def test_get_account_balance_contract(self, client, rpc_url):
        ...
        """
        try:
            # Use a sample address in the canonical ``0x`` spelling returned by the node.
            sample_address = "0x41aACd5F4009c0910A3419eeb82484Bf1bC63f3d"
            ...
            if response.status_code == 200:
                ...
                # The node normalises chain account addresses to the canonical ``0x`` spelling.
